...
HX_DEFINE_STACK_FRAME(_hx_pos_950062701a8f6a89_32_new,"cpp.Finalizable","new",0x5cbe4a08,"cpp.Finalizable.new","/home/kaiz0r/haxe/std/cpp/Finalizable.hx",32,0xd63632f9)
HX_LOCAL_STACK_FRAME(_hx_pos_950062701a8f6a89_35_finalize,"cpp.Finalizable","finalize",0xb32dcaf6,"cpp.Finalizable.finalize","/home/kaiz0r/haxe/std/cpp/Finalizable.hx",35,0xd63632f9)
namespace cpp{

void Finalizable_obj::__construct(hx::Null< bool >  __o_inPin){
            		bool inPin = __o_inPin.Default(false);
            	HX_STACKFRAME(&_hx_pos_950062701a8f6a89_32_new)
...
bool Finalizable_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x2284b5ae;
}

void Finalizable_obj::finalize(){
            	HX_STACKFRAME(&_hx_pos_950062701a8f6a89_35_finalize)
            	}
