...
HX_LOCAL_STACK_FRAME(_hx_pos_59a88dd66244e9bd_27_unsafeSet,"cpp.vm.Unsafe","unsafeSet",0x584fa140,"cpp.vm.Unsafe.unsafeSet","/home/kaiz0r/haxe/std/cpp/vm/Unsafe.hx",27,0xd55fae9c)
namespace cpp{
namespace vm{
...
bool Unsafe_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x75dc1dd8;
}

void Unsafe_obj::unsafeSet( ::Dynamic outForced, ::Dynamic inValue){
            	HX_STACKFRAME(&_hx_pos_59a88dd66244e9bd_27_unsafeSet)
