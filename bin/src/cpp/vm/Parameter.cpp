...
HX_DEFINE_STACK_FRAME(_hx_pos_b30c9a6f8b1c0914_34_new,"cpp.vm.Parameter","new",0xef7a672f,"cpp.vm.Parameter.new","/home/kaiz0r/haxe/std/cpp/vm/Debugger.hx",34,0x7bdd9681)
namespace cpp{
namespace vm{

void Parameter_obj::__construct(::String name, ::Dynamic value){
            	HX_STACKFRAME(&_hx_pos_b30c9a6f8b1c0914_34_new)
...
bool Parameter_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x3bac646f;
}
