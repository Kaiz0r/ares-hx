...
HX_LOCAL_STACK_FRAME(_hx_pos_dc51874b6a592aa8_27_start,"cpp.vm.Profiler","start",0x10ea16c9,"cpp.vm.Profiler.start","/home/kaiz0r/haxe/std/cpp/vm/Profiler.hx",27,0xf9541479)
HX_LOCAL_STACK_FRAME(_hx_pos_dc51874b6a592aa8_31_stop,"cpp.vm.Profiler","stop",0x99e7d77b,"cpp.vm.Profiler.stop","/home/kaiz0r/haxe/std/cpp/vm/Profiler.hx",31,0xf9541479)
namespace cpp{
namespace vm{
...
bool Profiler_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x2f5d0723;
}

void Profiler_obj::start(::String inDumpFile){
            	HX_STACKFRAME(&_hx_pos_dc51874b6a592aa8_27_start)
...
void Profiler_obj::stop(){
            	HX_STACKFRAME(&_hx_pos_dc51874b6a592aa8_31_stop)
