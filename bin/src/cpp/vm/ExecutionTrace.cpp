...
HX_LOCAL_STACK_FRAME(_hx_pos_95fcbeab0855f8a6_27_traceOff,"cpp.vm.ExecutionTrace","traceOff",0x0e75f7bf,"cpp.vm.ExecutionTrace.traceOff","/home/kaiz0r/haxe/std/cpp/vm/ExecutionTrace.hx",27,0x62be4d55)
HX_LOCAL_STACK_FRAME(_hx_pos_95fcbeab0855f8a6_31_traceFunctions,"cpp.vm.ExecutionTrace","traceFunctions",0xf1fc8aab,"cpp.vm.ExecutionTrace.traceFunctions","/home/kaiz0r/haxe/std/cpp/vm/ExecutionTrace.hx",31,0x62be4d55)
HX_LOCAL_STACK_FRAME(_hx_pos_95fcbeab0855f8a6_35_traceLines,"cpp.vm.ExecutionTrace","traceLines",0x5980f64f,"cpp.vm.ExecutionTrace.traceLines","/home/kaiz0r/haxe/std/cpp/vm/ExecutionTrace.hx",35,0x62be4d55)
namespace cpp{
namespace vm{
...
bool ExecutionTrace_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x31674f47;
}

void ExecutionTrace_obj::traceOff(){
            	HX_STACKFRAME(&_hx_pos_95fcbeab0855f8a6_27_traceOff)
...
void ExecutionTrace_obj::traceFunctions(){
            	HX_STACKFRAME(&_hx_pos_95fcbeab0855f8a6_31_traceFunctions)
...
void ExecutionTrace_obj::traceLines(){
            	HX_STACKFRAME(&_hx_pos_95fcbeab0855f8a6_35_traceLines)
