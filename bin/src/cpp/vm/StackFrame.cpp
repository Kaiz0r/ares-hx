...
HX_DEFINE_STACK_FRAME(_hx_pos_87578f69f90cea45_50_new,"cpp.vm.StackFrame","new",0x11668ca3,"cpp.vm.StackFrame.new","/home/kaiz0r/haxe/std/cpp/vm/Debugger.hx",50,0x7bdd9681)
namespace cpp{
namespace vm{

void StackFrame_obj::__construct(::String fileName,int lineNumber,::String className,::String functionName){
            	HX_STACKFRAME(&_hx_pos_87578f69f90cea45_50_new)
...
bool StackFrame_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x7f5d0f13;
}
