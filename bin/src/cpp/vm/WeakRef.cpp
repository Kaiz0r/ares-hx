...
HX_DEFINE_STACK_FRAME(_hx_pos_a698084a8819d5ff_29_new,"cpp.vm.WeakRef","new",0x9ce60541,"cpp.vm.WeakRef.new","/home/kaiz0r/haxe/std/cpp/vm/WeakRef.hx",29,0xb470a11f)
HX_LOCAL_STACK_FRAME(_hx_pos_a698084a8819d5ff_37_get,"cpp.vm.WeakRef","get",0x9ce0b577,"cpp.vm.WeakRef.get","/home/kaiz0r/haxe/std/cpp/vm/WeakRef.hx",37,0xb470a11f)
HX_LOCAL_STACK_FRAME(_hx_pos_a698084a8819d5ff_44_set,"cpp.vm.WeakRef","set",0x9ce9d083,"cpp.vm.WeakRef.set","/home/kaiz0r/haxe/std/cpp/vm/WeakRef.hx",44,0xb470a11f)
HX_LOCAL_STACK_FRAME(_hx_pos_a698084a8819d5ff_53_toString,"cpp.vm.WeakRef","toString",0x4fac4c2b,"cpp.vm.WeakRef.toString","/home/kaiz0r/haxe/std/cpp/vm/WeakRef.hx",53,0xb470a11f)
namespace cpp{
namespace vm{

void WeakRef_obj::__construct( ::Dynamic inObject,hx::Null< bool >  __o_inHard){
            		bool inHard = __o_inHard.Default(false);
            	HX_STACKFRAME(&_hx_pos_a698084a8819d5ff_29_new)
...
bool WeakRef_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x0e0931c9;
}

 ::Dynamic WeakRef_obj::get(){
            	HX_STACKFRAME(&_hx_pos_a698084a8819d5ff_37_get)
...
HX_DEFINE_DYNAMIC_FUNC0(WeakRef_obj,get,return )
 ...
 ::Dynamic WeakRef_obj::set( ::Dynamic inObject){
            	HX_STACKFRAME(&_hx_pos_a698084a8819d5ff_44_set)
...
::String WeakRef_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_a698084a8819d5ff_53_toString)
