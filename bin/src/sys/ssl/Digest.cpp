...
HX_LOCAL_STACK_FRAME(_hx_pos_664399325fbb8c15_30_make,"sys.ssl.Digest","make",0x90c1a135,"sys.ssl.Digest.make","/home/kaiz0r/haxe/std/cpp/_std/sys/ssl/Digest.hx",30,0x2ad092e6)
HX_LOCAL_STACK_FRAME(_hx_pos_664399325fbb8c15_34_sign,"sys.ssl.Digest","sign",0x94bef784,"sys.ssl.Digest.sign","/home/kaiz0r/haxe/std/cpp/_std/sys/ssl/Digest.hx",34,0x2ad092e6)
HX_LOCAL_STACK_FRAME(_hx_pos_664399325fbb8c15_38_verify,"sys.ssl.Digest","verify",0x68c88a80,"sys.ssl.Digest.verify","/home/kaiz0r/haxe/std/cpp/_std/sys/ssl/Digest.hx",38,0x2ad092e6)
namespace sys{
namespace ssl{
...
bool Digest_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x105d582f;
}

 ::haxe::io::Bytes Digest_obj::make( ::haxe::io::Bytes data,::String alg){
            	HX_STACKFRAME(&_hx_pos_664399325fbb8c15_30_make)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Digest_obj,make,return )
 ...
 ::haxe::io::Bytes Digest_obj::sign( ::haxe::io::Bytes data, ::sys::ssl::Key privKey,::String alg){
            	HX_STACKFRAME(&_hx_pos_664399325fbb8c15_34_sign)
...
bool Digest_obj::verify( ::haxe::io::Bytes data, ::haxe::io::Bytes signature, ::sys::ssl::Key pubKey,::String alg){
            	HX_STACKFRAME(&_hx_pos_664399325fbb8c15_38_verify)
