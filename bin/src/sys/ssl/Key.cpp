...
HX_DEFINE_STACK_FRAME(_hx_pos_10a0c9df3ff8d0ac_34_new,"sys.ssl.Key","new",0xfc27226e,"sys.ssl.Key.new","/home/kaiz0r/haxe/std/cpp/_std/sys/ssl/Key.hx",34,0x8f51cd13)
HX_LOCAL_STACK_FRAME(_hx_pos_03d5161c30843d99_55___init__,"::sys::ssl::Key_obj","__init__",0x25088cc6,"::sys::ssl::Key_obj.__init__","/home/kaiz0r/haxe/std/cpp/_std/sys/ssl/Key.hx",55,0x8f51cd13)
HX_LOCAL_STACK_FRAME(_hx_pos_10a0c9df3ff8d0ac_37_loadFile,"sys.ssl.Key","loadFile",0xd83e1af4,"sys.ssl.Key.loadFile","/home/kaiz0r/haxe/std/cpp/_std/sys/ssl/Key.hx",37,0x8f51cd13)
HX_LOCAL_STACK_FRAME(_hx_pos_10a0c9df3ff8d0ac_47_readPEM,"sys.ssl.Key","readPEM",0xcf4f5030,"sys.ssl.Key.readPEM","/home/kaiz0r/haxe/std/cpp/_std/sys/ssl/Key.hx",47,0x8f51cd13)
HX_LOCAL_STACK_FRAME(_hx_pos_10a0c9df3ff8d0ac_51_readDER,"sys.ssl.Key","readDER",0xcf463529,"sys.ssl.Key.readDER","/home/kaiz0r/haxe/std/cpp/_std/sys/ssl/Key.hx",51,0x8f51cd13)
namespace sys{
namespace ssl{

void Key_obj::__construct( ::Dynamic k){
            	HX_STACKFRAME(&_hx_pos_10a0c9df3ff8d0ac_34_new)
...
void Key_obj::__init__(){
            	HX_STACKFRAME(&_hx_pos_03d5161c30843d99_55___init__)
HXDLIN(  55)		_hx_ssl_init();
            	}


 ::sys::ssl::Key Key_obj::loadFile(::String file, ::Dynamic isPublic,::String pass){
            	HX_STACKFRAME(&_hx_pos_10a0c9df3ff8d0ac_37_loadFile)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(Key_obj,loadFile,return )
 ...
 ::sys::ssl::Key Key_obj::readPEM(::String data,bool isPublic,::String pass){
            	HX_GC_STACKFRAME(&_hx_pos_10a0c9df3ff8d0ac_47_readPEM)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(Key_obj,readPEM,return )
 ...
 ::sys::ssl::Key Key_obj::readDER( ::haxe::io::Bytes data,bool isPublic){
            	HX_GC_STACKFRAME(&_hx_pos_10a0c9df3ff8d0ac_51_readDER)
