...
HX_DEFINE_STACK_FRAME(_hx_pos_55c8b7a763375185_94_new,"sys.io.Process","new",0x849b4c7a,"sys.io.Process.new","/home/kaiz0r/haxe/std/cpp/_std/sys/io/Process.hx",94,0x167853e7)
HX_LOCAL_STACK_FRAME(_hx_pos_55c8b7a763375185_104_getPid,"sys.io.Process","getPid",0xcce2217b,"sys.io.Process.getPid","/home/kaiz0r/haxe/std/cpp/_std/sys/io/Process.hx",104,0x167853e7)
HX_LOCAL_STACK_FRAME(_hx_pos_55c8b7a763375185_107_exitCode,"sys.io.Process","exitCode",0x41e72111,"sys.io.Process.exitCode","/home/kaiz0r/haxe/std/cpp/_std/sys/io/Process.hx",107,0x167853e7)
HX_LOCAL_STACK_FRAME(_hx_pos_55c8b7a763375185_114_close,"sys.io.Process","close",0x0a954e52,"sys.io.Process.close","/home/kaiz0r/haxe/std/cpp/_std/sys/io/Process.hx",114,0x167853e7)
HX_LOCAL_STACK_FRAME(_hx_pos_55c8b7a763375185_118_kill,"sys.io.Process","kill",0x814efa44,"sys.io.Process.kill","/home/kaiz0r/haxe/std/cpp/_std/sys/io/Process.hx",118,0x167853e7)
namespace sys{
namespace io{

void Process_obj::__construct(::String cmd,::Array< ::String > args, ::Dynamic detached){
            	HX_GC_STACKFRAME(&_hx_pos_55c8b7a763375185_94_new)
...
int Process_obj::getPid(){
            	HX_STACKFRAME(&_hx_pos_55c8b7a763375185_104_getPid)
...
HX_DEFINE_DYNAMIC_FUNC0(Process_obj,getPid,return )
 ...
 ::Dynamic Process_obj::exitCode(hx::Null< bool >  __o_block){
            	...
            	HX_STACKFRAME(&_hx_pos_55c8b7a763375185_107_exitCode)
HXLINE( 108)		if ((block == false)) {
HXLINE( 109)			HX_STACK_DO_THROW(HX_("Non blocking exitCode() not supported on this platform",af,cf,0a,4c));
            		}
...
void Process_obj::close(){
            	HX_STACKFRAME(&_hx_pos_55c8b7a763375185_114_close)
...
void Process_obj::kill(){
            	HX_STACKFRAME(&_hx_pos_55c8b7a763375185_118_kill)
