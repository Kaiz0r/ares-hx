...
HX_DEFINE_STACK_FRAME(_hx_pos_67527e3a79a1141a_136_new,"sys.db._Mysql.MysqlConnection","new",0x687304d6,"sys.db._Mysql.MysqlConnection.new","/home/kaiz0r/haxe/std/cpp/_std/sys/db/Mysql.hx",136,0x961fa97c)
HX_LOCAL_STACK_FRAME(_hx_pos_67527e3a79a1141a_141_request,"sys.db._Mysql.MysqlConnection","request",0x6f9686c5,"sys.db._Mysql.MysqlConnection.request","/home/kaiz0r/haxe/std/cpp/_std/sys/db/Mysql.hx",141,0x961fa97c)
HX_LOCAL_STACK_FRAME(_hx_pos_67527e3a79a1141a_147_close,"sys.db._Mysql.MysqlConnection","close",0x5e10d5ae,"sys.db._Mysql.MysqlConnection.close","/home/kaiz0r/haxe/std/cpp/_std/sys/db/Mysql.hx",147,0x961fa97c)
HX_LOCAL_STACK_FRAME(_hx_pos_67527e3a79a1141a_151_escape,"sys.db._Mysql.MysqlConnection","escape",0xbd32bccb,"sys.db._Mysql.MysqlConnection.escape","/home/kaiz0r/haxe/std/cpp/_std/sys/db/Mysql.hx",151,0x961fa97c)
HX_LOCAL_STACK_FRAME(_hx_pos_67527e3a79a1141a_155_quote,"sys.db._Mysql.MysqlConnection","quote",0x739fe132,"sys.db._Mysql.MysqlConnection.quote","/home/kaiz0r/haxe/std/cpp/_std/sys/db/Mysql.hx",155,0x961fa97c)
HX_LOCAL_STACK_FRAME(_hx_pos_67527e3a79a1141a_159_addValue,"sys.db._Mysql.MysqlConnection","addValue",0x2f76855a,"sys.db._Mysql.MysqlConnection.addValue","/home/kaiz0r/haxe/std/cpp/_std/sys/db/Mysql.hx",159,0x961fa97c)
HX_LOCAL_STACK_FRAME(_hx_pos_67527e3a79a1141a_178_lastInsertId,"sys.db._Mysql.MysqlConnection","lastInsertId",0x025f1cb4,"sys.db._Mysql.MysqlConnection.lastInsertId","/home/kaiz0r/haxe/std/cpp/_std/sys/db/Mysql.hx",178,0x961fa97c)
HX_LOCAL_STACK_FRAME(_hx_pos_67527e3a79a1141a_182_dbName,"sys.db._Mysql.MysqlConnection","dbName",0x7f260633,"sys.db._Mysql.MysqlConnection.dbName","/home/kaiz0r/haxe/std/cpp/_std/sys/db/Mysql.hx",182,0x961fa97c)
HX_LOCAL_STACK_FRAME(_hx_pos_67527e3a79a1141a_186_startTransaction,"sys.db._Mysql.MysqlConnection","startTransaction",0x6bd2b666,"sys.db._Mysql.MysqlConnection.startTransaction","/home/kaiz0r/haxe/std/cpp/_std/sys/db/Mysql.hx",186,0x961fa97c)
HX_LOCAL_STACK_FRAME(_hx_pos_67527e3a79a1141a_190_commit,"sys.db._Mysql.MysqlConnection","commit",0xa986e941,"sys.db._Mysql.MysqlConnection.commit","/home/kaiz0r/haxe/std/cpp/_std/sys/db/Mysql.hx",190,0x961fa97c)
HX_LOCAL_STACK_FRAME(_hx_pos_67527e3a79a1141a_194_rollback,"sys.db._Mysql.MysqlConnection","rollback",0xa388a7ee,"sys.db._Mysql.MysqlConnection.rollback","/home/kaiz0r/haxe/std/cpp/_std/sys/db/Mysql.hx",194,0x961fa97c)
HX_LOCAL_STACK_FRAME(_hx_pos_67527e3a79a1141a_197_boot,"sys.db._Mysql.MysqlConnection","boot",0xf44a36fc,"sys.db._Mysql.MysqlConnection.boot","/home/kaiz0r/haxe/std/cpp/_std/sys/db/Mysql.hx",197,0x961fa97c)
namespace sys{
namespace db{
namespace _Mysql{

void MysqlConnection_obj::__construct( ::Dynamic c){
            	HX_STACKFRAME(&_hx_pos_67527e3a79a1141a_136_new)
...
bool MysqlConnection_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x50b05972;
}
...
::Dynamic MysqlConnection_obj::request(::String s){
            	HX_GC_STACKFRAME(&_hx_pos_67527e3a79a1141a_141_request)
...
void MysqlConnection_obj::close(){
            	HX_STACKFRAME(&_hx_pos_67527e3a79a1141a_147_close)
...
::String MysqlConnection_obj::escape(::String s){
            	HX_STACKFRAME(&_hx_pos_67527e3a79a1141a_151_escape)
...
::String MysqlConnection_obj::quote(::String s){
            	HX_STACKFRAME(&_hx_pos_67527e3a79a1141a_155_quote)
...
void MysqlConnection_obj::addValue( ::StringBuf s, ::Dynamic v){
            	HX_STACKFRAME(&_hx_pos_67527e3a79a1141a_159_addValue)
...
HXLINE( 161)			if (::Std_obj::is(v,hx::ClassOf< bool >())) {
HXLINE( 162)				int x1;
...
HXLINE( 162)					s->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x1));
            				}
            				else {
HXLINE( 162)					::Array< ::String > s2 = s->b;
HXDLIN( 162)					s2->push(::Std_obj::string(x1));
            				}
            			}
            			else {
HXLINE( 164)				int t = ( (int)(v->__GetType()) );
HXLINE( 165)				if ((t == 255)) {
HXLINE( 166)					 ::Dynamic x2 = v;
HXDLIN( 166)					if (hx::IsNotNull( s->charBuf )) {
HXLINE( 166)						s->flush();
            					}
HXDLIN( 166)					if (hx::IsNull( s->b )) {
HXLINE( 166)						s->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x2));
            					}
            					else {
HXLINE( 166)						::Array< ::String > s3 = s->b;
HXDLIN( 166)						s3->push(::Std_obj::string(x2));
            					}
            				}
            				else {
HXLINE( 167)					if ((t == 2)) {
HXLINE( 168)						 ::Dynamic x3;
...
HXLINE( 168)							s->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x3));
            						}
            						else {
HXLINE( 168)							::Array< ::String > s4 = s->b;
HXDLIN( 168)							s4->push(::Std_obj::string(x3));
            						}
            					}
            					else {
HXLINE( 170)						{
...
HXLINE( 171)						{
HXLINE( 171)							::String x4 = this->escape(::Std_obj::string(v));
HXDLIN( 171)							if (hx::IsNotNull( s->charBuf )) {
HXLINE( 171)								s->flush();
            							}
HXDLIN( 171)							if (hx::IsNull( s->b )) {
HXLINE( 171)								s->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x4));
            							}
            							else {
HXLINE( 171)								::Array< ::String > s5 = s->b;
HXDLIN( 171)								s5->push(::Std_obj::string(x4));
            							}
            						}
HXLINE( 172)						{
...
int MysqlConnection_obj::lastInsertId(){
            	HX_STACKFRAME(&_hx_pos_67527e3a79a1141a_178_lastInsertId)
...
::String MysqlConnection_obj::dbName(){
            	HX_STACKFRAME(&_hx_pos_67527e3a79a1141a_182_dbName)
...
void MysqlConnection_obj::startTransaction(){
            	HX_STACKFRAME(&_hx_pos_67527e3a79a1141a_186_startTransaction)
...
void MysqlConnection_obj::commit(){
            	HX_STACKFRAME(&_hx_pos_67527e3a79a1141a_190_commit)
...
void MysqlConnection_obj::rollback(){
            	HX_STACKFRAME(&_hx_pos_67527e3a79a1141a_194_rollback)
...
{
{
            	HX_STACKFRAME(&_hx_pos_67527e3a79a1141a_197_boot)
