...
HX_LOCAL_STACK_FRAME(_hx_pos_7b6410917866d502_67_charsToBytes,"sys.db._Mysql.D","charsToBytes",0x14060359,"sys.db._Mysql.D.charsToBytes","/home/kaiz0r/haxe/std/cpp/_std/sys/db/Mysql.hx",67,0x961fa97c)
HX_LOCAL_STACK_FRAME(_hx_pos_7b6410917866d502_70_secondsToDate,"sys.db._Mysql.D","secondsToDate",0x345744a2,"sys.db._Mysql.D.secondsToDate","/home/kaiz0r/haxe/std/cpp/_std/sys/db/Mysql.hx",70,0x961fa97c)
namespace sys{
namespace db{
namespace _Mysql{
...
bool D_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x23114976;
}

 ::Dynamic D_obj::charsToBytes( ::Dynamic data){
            	HX_STACKFRAME(&_hx_pos_7b6410917866d502_67_charsToBytes)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(D_obj,charsToBytes,return )
 ...
 ::Dynamic D_obj::secondsToDate(Float seconds){
            	HX_STACKFRAME(&_hx_pos_7b6410917866d502_70_secondsToDate)
