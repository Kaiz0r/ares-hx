...
HX_DEFINE_STACK_FRAME(_hx_pos_96c40f6da9673c1c_81_new,"sys.db._Mysql.MysqlResultSet","new",0xb14fd831,"sys.db._Mysql.MysqlResultSet.new","/home/kaiz0r/haxe/std/cpp/_std/sys/db/Mysql.hx",81,0x961fa97c)
HX_LOCAL_STACK_FRAME(_hx_pos_96c40f6da9673c1c_85_get_length,"sys.db._Mysql.MysqlResultSet","get_length",0x496108fe,"sys.db._Mysql.MysqlResultSet.get_length","/home/kaiz0r/haxe/std/cpp/_std/sys/db/Mysql.hx",85,0x961fa97c)
HX_LOCAL_STACK_FRAME(_hx_pos_96c40f6da9673c1c_89_get_nfields,"sys.db._Mysql.MysqlResultSet","get_nfields",0xc2b3b64f,"sys.db._Mysql.MysqlResultSet.get_nfields","/home/kaiz0r/haxe/std/cpp/_std/sys/db/Mysql.hx",89,0x961fa97c)
HX_LOCAL_STACK_FRAME(_hx_pos_96c40f6da9673c1c_92_hasNext,"sys.db._Mysql.MysqlResultSet","hasNext",0x1c1169be,"sys.db._Mysql.MysqlResultSet.hasNext","/home/kaiz0r/haxe/std/cpp/_std/sys/db/Mysql.hx",92,0x961fa97c)
HX_LOCAL_STACK_FRAME(_hx_pos_96c40f6da9673c1c_98_next,"sys.db._Mysql.MysqlResultSet","next",0x748d5402,"sys.db._Mysql.MysqlResultSet.next","/home/kaiz0r/haxe/std/cpp/_std/sys/db/Mysql.hx",98,0x961fa97c)
HX_LOCAL_STACK_FRAME(_hx_pos_96c40f6da9673c1c_108_results,"sys.db._Mysql.MysqlResultSet","results",0x6f221d47,"sys.db._Mysql.MysqlResultSet.results","/home/kaiz0r/haxe/std/cpp/_std/sys/db/Mysql.hx",108,0x961fa97c)
HX_LOCAL_STACK_FRAME(_hx_pos_96c40f6da9673c1c_116_getResult,"sys.db._Mysql.MysqlResultSet","getResult",0x241c2ca4,"sys.db._Mysql.MysqlResultSet.getResult","/home/kaiz0r/haxe/std/cpp/_std/sys/db/Mysql.hx",116,0x961fa97c)
HX_LOCAL_STACK_FRAME(_hx_pos_96c40f6da9673c1c_120_getIntResult,"sys.db._Mysql.MysqlResultSet","getIntResult",0x927159c5,"sys.db._Mysql.MysqlResultSet.getIntResult","/home/kaiz0r/haxe/std/cpp/_std/sys/db/Mysql.hx",120,0x961fa97c)
HX_LOCAL_STACK_FRAME(_hx_pos_96c40f6da9673c1c_124_getFloatResult,"sys.db._Mysql.MysqlResultSet","getFloatResult",0x590fea72,"sys.db._Mysql.MysqlResultSet.getFloatResult","/home/kaiz0r/haxe/std/cpp/_std/sys/db/Mysql.hx",124,0x961fa97c)
HX_LOCAL_STACK_FRAME(_hx_pos_96c40f6da9673c1c_127_getFieldsNames,"sys.db._Mysql.MysqlResultSet","getFieldsNames",0x9e398568,"sys.db._Mysql.MysqlResultSet.getFieldsNames","/home/kaiz0r/haxe/std/cpp/_std/sys/db/Mysql.hx",127,0x961fa97c)
namespace sys{
namespace db{
namespace _Mysql{

void MysqlResultSet_obj::__construct( ::Dynamic r){
            	HX_STACKFRAME(&_hx_pos_96c40f6da9673c1c_81_new)
...
bool MysqlResultSet_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x1df5dff1;
}
...
int MysqlResultSet_obj::get_length(){
            	HX_STACKFRAME(&_hx_pos_96c40f6da9673c1c_85_get_length)
...
int MysqlResultSet_obj::get_nfields(){
            	HX_STACKFRAME(&_hx_pos_96c40f6da9673c1c_89_get_nfields)
...
bool MysqlResultSet_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_96c40f6da9673c1c_92_hasNext)
...
HX_DEFINE_DYNAMIC_FUNC0(MysqlResultSet_obj,hasNext,return )
 ...
 ::Dynamic MysqlResultSet_obj::next(){
            	HX_STACKFRAME(&_hx_pos_96c40f6da9673c1c_98_next)
...
HX_DEFINE_DYNAMIC_FUNC0(MysqlResultSet_obj,next,return )
 ...
 ::haxe::ds::List MysqlResultSet_obj::results(){
            	HX_GC_STACKFRAME(&_hx_pos_96c40f6da9673c1c_108_results)
...
::String MysqlResultSet_obj::getResult(int n){
            	HX_STACKFRAME(&_hx_pos_96c40f6da9673c1c_116_getResult)
...
int MysqlResultSet_obj::getIntResult(int n){
            	HX_STACKFRAME(&_hx_pos_96c40f6da9673c1c_120_getIntResult)
...
Float MysqlResultSet_obj::getFloatResult(int n){
            	HX_STACKFRAME(&_hx_pos_96c40f6da9673c1c_124_getFloatResult)
...
::Array< ::String > MysqlResultSet_obj::getFieldsNames(){
            	HX_STACKFRAME(&_hx_pos_96c40f6da9673c1c_127_getFieldsNames)
