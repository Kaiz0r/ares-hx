...
HX_LOCAL_STACK_FRAME(_hx_pos_011503850a9d7cee_209_connect,"sys.db.Mysql","connect",0x2cf3750f,"sys.db.Mysql.connect","/home/kaiz0r/haxe/std/cpp/_std/sys/db/Mysql.hx",209,0x961fa97c)
namespace sys{
namespace db{
...
bool Mysql_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x467324d7;
}

::Dynamic Mysql_obj::connect( ::Dynamic params){
            	HX_GC_STACKFRAME(&_hx_pos_011503850a9d7cee_209_connect)
