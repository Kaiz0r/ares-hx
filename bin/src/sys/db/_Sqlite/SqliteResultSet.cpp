...
HX_DEFINE_STACK_FRAME(_hx_pos_cd9e4656ccf92be6_116_new,"sys.db._Sqlite.SqliteResultSet","new",0x31627399,"sys.db._Sqlite.SqliteResultSet.new","/home/kaiz0r/haxe/std/cpp/_std/sys/db/Sqlite.hx",116,0x571bb5d2)
HX_LOCAL_STACK_FRAME(_hx_pos_cd9e4656ccf92be6_122_get_length,"sys.db._Sqlite.SqliteResultSet","get_length",0x97262a96,"sys.db._Sqlite.SqliteResultSet.get_length","/home/kaiz0r/haxe/std/cpp/_std/sys/db/Sqlite.hx",122,0x571bb5d2)
HX_LOCAL_STACK_FRAME(_hx_pos_cd9e4656ccf92be6_136_get_nfields,"sys.db._Sqlite.SqliteResultSet","get_nfields",0x816bf9b7,"sys.db._Sqlite.SqliteResultSet.get_nfields","/home/kaiz0r/haxe/std/cpp/_std/sys/db/Sqlite.hx",136,0x571bb5d2)
HX_LOCAL_STACK_FRAME(_hx_pos_cd9e4656ccf92be6_139_hasNext,"sys.db._Sqlite.SqliteResultSet","hasNext",0x0ab9d926,"sys.db._Sqlite.SqliteResultSet.hasNext","/home/kaiz0r/haxe/std/cpp/_std/sys/db/Sqlite.hx",139,0x571bb5d2)
HX_LOCAL_STACK_FRAME(_hx_pos_cd9e4656ccf92be6_147_next,"sys.db._Sqlite.SqliteResultSet","next",0x04c2b39a,"sys.db._Sqlite.SqliteResultSet.next","/home/kaiz0r/haxe/std/cpp/_std/sys/db/Sqlite.hx",147,0x571bb5d2)
HX_LOCAL_STACK_FRAME(_hx_pos_cd9e4656ccf92be6_154_results,"sys.db._Sqlite.SqliteResultSet","results",0x5dca8caf,"sys.db._Sqlite.SqliteResultSet.results","/home/kaiz0r/haxe/std/cpp/_std/sys/db/Sqlite.hx",154,0x571bb5d2)
HX_LOCAL_STACK_FRAME(_hx_pos_cd9e4656ccf92be6_166_getResult,"sys.db._Sqlite.SqliteResultSet","getResult",0x614d460c,"sys.db._Sqlite.SqliteResultSet.getResult","/home/kaiz0r/haxe/std/cpp/_std/sys/db/Sqlite.hx",166,0x571bb5d2)
HX_LOCAL_STACK_FRAME(_hx_pos_cd9e4656ccf92be6_170_getIntResult,"sys.db._Sqlite.SqliteResultSet","getIntResult",0xb4f4115d,"sys.db._Sqlite.SqliteResultSet.getIntResult","/home/kaiz0r/haxe/std/cpp/_std/sys/db/Sqlite.hx",170,0x571bb5d2)
HX_LOCAL_STACK_FRAME(_hx_pos_cd9e4656ccf92be6_174_getFloatResult,"sys.db._Sqlite.SqliteResultSet","getFloatResult",0x2b61b80a,"sys.db._Sqlite.SqliteResultSet.getFloatResult","/home/kaiz0r/haxe/std/cpp/_std/sys/db/Sqlite.hx",174,0x571bb5d2)
HX_LOCAL_STACK_FRAME(_hx_pos_cd9e4656ccf92be6_178_getFieldsNames,"sys.db._Sqlite.SqliteResultSet","getFieldsNames",0x708b5300,"sys.db._Sqlite.SqliteResultSet.getFieldsNames","/home/kaiz0r/haxe/std/cpp/_std/sys/db/Sqlite.hx",178,0x571bb5d2)
namespace sys{
namespace db{
namespace _Sqlite{

void SqliteResultSet_obj::__construct( ::Dynamic r){
            	HX_GC_STACKFRAME(&_hx_pos_cd9e4656ccf92be6_116_new)
...
int SqliteResultSet_obj::get_length(){
            	HX_STACKFRAME(&_hx_pos_cd9e4656ccf92be6_122_get_length)
HXLINE( 123)		if ((this->get_nfields() != 0)) {
HXLINE( 124)			while(true){
HXLINE( 125)				 ::Dynamic c = _hx_sqlite_result_next(this->r);
HXLINE( 126)				if (hx::IsNull( c )) {
HXLINE( 127)					goto _hx_goto_1;
            				}
HXLINE( 128)				this->cache->add(c);
            			}
            			_hx_goto_1:;
HXLINE( 130)			return this->cache->length;
            		}
HXLINE( 132)		return _hx_sqlite_result_get_length(this->r);
            	}
...
int SqliteResultSet_obj::get_nfields(){
            	HX_STACKFRAME(&_hx_pos_cd9e4656ccf92be6_136_get_nfields)
HXDLIN( 136)		return _hx_sqlite_result_get_nfields(this->r);
            	}
...
bool SqliteResultSet_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_cd9e4656ccf92be6_139_hasNext)
...
HX_DEFINE_DYNAMIC_FUNC0(SqliteResultSet_obj,hasNext,return )
 ...
 ::Dynamic SqliteResultSet_obj::next(){
            	HX_STACKFRAME(&_hx_pos_cd9e4656ccf92be6_147_next)
...
HX_DEFINE_DYNAMIC_FUNC0(SqliteResultSet_obj,next,return )
 ...
 ::haxe::ds::List SqliteResultSet_obj::results(){
            	HX_GC_STACKFRAME(&_hx_pos_cd9e4656ccf92be6_154_results)
HXLINE( 155)		 ::haxe::ds::List l =  ::haxe::ds::List_obj::__alloc( HX_CTX );
HXLINE( 156)		while(true){
HXLINE( 157)			 ::Dynamic c = this->next();
HXLINE( 158)			if (hx::IsNull( c )) {
...
::String SqliteResultSet_obj::getResult(int n){
            	HX_STACKFRAME(&_hx_pos_cd9e4656ccf92be6_166_getResult)
HXDLIN( 166)		return ::String(_hx_sqlite_result_get(this->r,n));
            	}
...
int SqliteResultSet_obj::getIntResult(int n){
            	HX_STACKFRAME(&_hx_pos_cd9e4656ccf92be6_170_getIntResult)
HXDLIN( 170)		return _hx_sqlite_result_get_int(this->r,n);
            	}
...
Float SqliteResultSet_obj::getFloatResult(int n){
            	HX_STACKFRAME(&_hx_pos_cd9e4656ccf92be6_174_getFloatResult)
HXDLIN( 174)		return _hx_sqlite_result_get_float(this->r,n);
            	}
...
::Array< ::String > SqliteResultSet_obj::getFieldsNames(){
            	HX_STACKFRAME(&_hx_pos_cd9e4656ccf92be6_178_getFieldsNames)
