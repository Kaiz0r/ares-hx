...
HX_DEFINE_STACK_FRAME(_hx_pos_9da62442f3d6f7fc_29_new,"sys.db._Sqlite.SqliteConnection","new",0xf8a8646e,"sys.db._Sqlite.SqliteConnection.new","/home/kaiz0r/haxe/std/cpp/_std/sys/db/Sqlite.hx",29,0x571bb5d2)
HX_LOCAL_STACK_FRAME(_hx_pos_9da62442f3d6f7fc_33_close,"sys.db._Sqlite.SqliteConnection","close",0x6e0f4b46,"sys.db._Sqlite.SqliteConnection.close","/home/kaiz0r/haxe/std/cpp/_std/sys/db/Sqlite.hx",33,0x571bb5d2)
HX_LOCAL_STACK_FRAME(_hx_pos_9da62442f3d6f7fc_37_request,"sys.db._Sqlite.SqliteConnection","request",0x544f925d,"sys.db._Sqlite.SqliteConnection.request","/home/kaiz0r/haxe/std/cpp/_std/sys/db/Sqlite.hx",37,0x571bb5d2)
HX_LOCAL_STACK_FRAME(_hx_pos_9da62442f3d6f7fc_45_escape,"sys.db._Sqlite.SqliteConnection","escape",0xabdb2c33,"sys.db._Sqlite.SqliteConnection.escape","/home/kaiz0r/haxe/std/cpp/_std/sys/db/Sqlite.hx",45,0x571bb5d2)
HX_LOCAL_STACK_FRAME(_hx_pos_9da62442f3d6f7fc_48_quote,"sys.db._Sqlite.SqliteConnection","quote",0x839e56ca,"sys.db._Sqlite.SqliteConnection.quote","/home/kaiz0r/haxe/std/cpp/_std/sys/db/Sqlite.hx",48,0x571bb5d2)
HX_LOCAL_STACK_FRAME(_hx_pos_9da62442f3d6f7fc_59_addValue,"sys.db._Sqlite.SqliteConnection","addValue",0x6ca79ec2,"sys.db._Sqlite.SqliteConnection.addValue","/home/kaiz0r/haxe/std/cpp/_std/sys/db/Sqlite.hx",59,0x571bb5d2)
HX_LOCAL_STACK_FRAME(_hx_pos_9da62442f3d6f7fc_75_lastInsertId,"sys.db._Sqlite.SqliteConnection","lastInsertId",0x123d0a1c,"sys.db._Sqlite.SqliteConnection.lastInsertId","/home/kaiz0r/haxe/std/cpp/_std/sys/db/Sqlite.hx",75,0x571bb5d2)
HX_LOCAL_STACK_FRAME(_hx_pos_9da62442f3d6f7fc_79_dbName,"sys.db._Sqlite.SqliteConnection","dbName",0x6dce759b,"sys.db._Sqlite.SqliteConnection.dbName","/home/kaiz0r/haxe/std/cpp/_std/sys/db/Sqlite.hx",79,0x571bb5d2)
HX_LOCAL_STACK_FRAME(_hx_pos_9da62442f3d6f7fc_83_startTransaction,"sys.db._Sqlite.SqliteConnection","startTransaction",0x075777ce,"sys.db._Sqlite.SqliteConnection.startTransaction","/home/kaiz0r/haxe/std/cpp/_std/sys/db/Sqlite.hx",83,0x571bb5d2)
HX_LOCAL_STACK_FRAME(_hx_pos_9da62442f3d6f7fc_86_commit,"sys.db._Sqlite.SqliteConnection","commit",0x982f58a9,"sys.db._Sqlite.SqliteConnection.commit","/home/kaiz0r/haxe/std/cpp/_std/sys/db/Sqlite.hx",86,0x571bb5d2)
HX_LOCAL_STACK_FRAME(_hx_pos_9da62442f3d6f7fc_91_rollback,"sys.db._Sqlite.SqliteConnection","rollback",0xe0b9c156,"sys.db._Sqlite.SqliteConnection.rollback","/home/kaiz0r/haxe/std/cpp/_std/sys/db/Sqlite.hx",91,0x571bb5d2)
namespace sys{
namespace db{
namespace _Sqlite{

void SqliteConnection_obj::__construct(::String file){
            	HX_STACKFRAME(&_hx_pos_9da62442f3d6f7fc_29_new)
...
void SqliteConnection_obj::close(){
            	HX_STACKFRAME(&_hx_pos_9da62442f3d6f7fc_33_close)
...
::Dynamic SqliteConnection_obj::request(::String s){
            	HX_GC_STACKFRAME(&_hx_pos_9da62442f3d6f7fc_37_request)
HXDLIN(  37)		try {
...
::String SqliteConnection_obj::escape(::String s){
            	HX_STACKFRAME(&_hx_pos_9da62442f3d6f7fc_45_escape)
...
::String SqliteConnection_obj::quote(::String s){
            	HX_STACKFRAME(&_hx_pos_9da62442f3d6f7fc_48_quote)
...
void SqliteConnection_obj::addValue( ::StringBuf s, ::Dynamic v){
            	HX_STACKFRAME(&_hx_pos_9da62442f3d6f7fc_59_addValue)
...
HXLINE(  61)			if (::Std_obj::is(v,hx::ClassOf< bool >())) {
HXLINE(  62)				int x1;
HXDLIN(  62)				if (( (bool)(v) )) {
HXLINE(  62)					x1 = 1;
            				}
...
HXLINE(  62)					s->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x1));
            				}
            				else {
HXLINE(  62)					::Array< ::String > s2 = s->b;
HXDLIN(  62)					s2->push(::Std_obj::string(x1));
            				}
            			}
            			else {
HXLINE(  64)				int t = ( (int)(v->__GetType()) );
HXLINE(  65)				if ((t == 255)) {
HXLINE(  66)					 ::Dynamic x2 = v;
HXDLIN(  66)					if (hx::IsNotNull( s->charBuf )) {
HXLINE(  66)						s->flush();
            					}
HXDLIN(  66)					if (hx::IsNull( s->b )) {
HXLINE(  66)						s->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x2));
            					}
            					else {
HXLINE(  66)						::Array< ::String > s3 = s->b;
HXDLIN(  66)						s3->push(::Std_obj::string(x2));
            					}
            				}
            				else {
HXLINE(  67)					if ((t == 2)) {
HXLINE(  68)						 ::Dynamic x3 = v->__Field(HX_("__GetInt",39,25,e3,7f),hx::paccDynamic)();
HXDLIN(  68)						if (hx::IsNotNull( s->charBuf )) {
HXLINE(  68)							s->flush();
            						}
HXDLIN(  68)						if (hx::IsNull( s->b )) {
HXLINE(  68)							s->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x3));
            						}
            						else {
HXLINE(  68)							::Array< ::String > s4 = s->b;
HXDLIN(  68)							s4->push(::Std_obj::string(x3));
            						}
            					}
            					else {
HXLINE(  70)						::String x4 = this->quote(::Std_obj::string(v));
HXDLIN(  70)						if (hx::IsNotNull( s->charBuf )) {
HXLINE(  70)							s->flush();
            						}
HXDLIN(  70)						if (hx::IsNull( s->b )) {
HXLINE(  70)							s->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x4));
            						}
            						else {
HXLINE(  70)							::Array< ::String > s5 = s->b;
HXDLIN(  70)							s5->push(::Std_obj::string(x4));
            						}
            					}
            				}
            			}
...
int SqliteConnection_obj::lastInsertId(){
            	HX_STACKFRAME(&_hx_pos_9da62442f3d6f7fc_75_lastInsertId)
...
::String SqliteConnection_obj::dbName(){
            	HX_STACKFRAME(&_hx_pos_9da62442f3d6f7fc_79_dbName)
...
void SqliteConnection_obj::startTransaction(){
            	HX_STACKFRAME(&_hx_pos_9da62442f3d6f7fc_83_startTransaction)
...
void SqliteConnection_obj::commit(){
            	HX_STACKFRAME(&_hx_pos_9da62442f3d6f7fc_86_commit)
HXLINE(  87)		this->request(HX_("COMMIT",f7,1b,b1,79));
HXLINE(  88)		this->startTransaction();
            	}
...
void SqliteConnection_obj::rollback(){
            	HX_STACKFRAME(&_hx_pos_9da62442f3d6f7fc_91_rollback)
HXLINE(  92)		this->request(HX_("ROLLBACK",24,58,ad,78));
HXLINE(  93)		this->startTransaction();
            	}
