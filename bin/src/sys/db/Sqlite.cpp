...
HX_LOCAL_STACK_FRAME(_hx_pos_575e57c5e26e5181_203_open,"sys.db.Sqlite","open",0x1432cbdd,"sys.db.Sqlite.open","/home/kaiz0r/haxe/std/cpp/_std/sys/db/Sqlite.hx",203,0x571bb5d2)
namespace sys{
namespace db{
...
::Dynamic Sqlite_obj::open(::String file){
            	HX_GC_STACKFRAME(&_hx_pos_575e57c5e26e5181_203_open)
