...
HX_DEFINE_STACK_FRAME(_hx_pos_cabd3a2a42aacf01_29_new,"sys.net.UdpSocket","new",0x7361a534,"sys.net.UdpSocket.new","/home/kaiz0r/haxe/std/cpp/_std/sys/net/UdpSocket.hx",29,0x6270d7cd)
HX_LOCAL_STACK_FRAME(_hx_pos_cabd3a2a42aacf01_30_init,"sys.net.UdpSocket","init",0x7ec79fbc,"sys.net.UdpSocket.init","/home/kaiz0r/haxe/std/cpp/_std/sys/net/UdpSocket.hx",30,0x6270d7cd)
HX_LOCAL_STACK_FRAME(_hx_pos_cabd3a2a42aacf01_36_sendTo,"sys.net.UdpSocket","sendTo",0x4bf4a08f,"sys.net.UdpSocket.sendTo","/home/kaiz0r/haxe/std/cpp/_std/sys/net/UdpSocket.hx",36,0x6270d7cd)
HX_LOCAL_STACK_FRAME(_hx_pos_cabd3a2a42aacf01_46_readFrom,"sys.net.UdpSocket","readFrom",0x35b4aa8c,"sys.net.UdpSocket.readFrom","/home/kaiz0r/haxe/std/cpp/_std/sys/net/UdpSocket.hx",46,0x6270d7cd)
HX_LOCAL_STACK_FRAME(_hx_pos_cabd3a2a42aacf01_62_setBroadcast,"sys.net.UdpSocket","setBroadcast",0x2fac53ab,"sys.net.UdpSocket.setBroadcast","/home/kaiz0r/haxe/std/cpp/_std/sys/net/UdpSocket.hx",62,0x6270d7cd)
namespace sys{
namespace net{

void UdpSocket_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_cabd3a2a42aacf01_29_new)
...
bool UdpSocket_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x109f852f) {
		return inClassId==(int)0x00000001 || inClassId==(int)0x109f852f;
	} else {
		return inClassId==(int)0x5316b784;
	}
}

void UdpSocket_obj::init(){
            	HX_STACKFRAME(&_hx_pos_cabd3a2a42aacf01_30_init)
...
int UdpSocket_obj::sendTo( ::haxe::io::Bytes buf,int pos,int len, ::sys::net::Address addr){
            	HX_STACKFRAME(&_hx_pos_cabd3a2a42aacf01_36_sendTo)
HXDLIN(  36)		try {
...
int UdpSocket_obj::readFrom( ::haxe::io::Bytes buf,int pos,int len, ::sys::net::Address addr){
            	HX_GC_STACKFRAME(&_hx_pos_cabd3a2a42aacf01_46_readFrom)
HXLINE(  47)		int r;
HXLINE(  48)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
...
void UdpSocket_obj::setBroadcast(bool b){
            	HX_STACKFRAME(&_hx_pos_cabd3a2a42aacf01_62_setBroadcast)
