...
HX_LOCAL_STACK_FRAME(_hx_pos_eb96856fbcf5bf72_45_array,"Lambda","array",0x9c8b0512,"Lambda.array","/home/kaiz0r/haxe/std/Lambda.hx",45,0x59846327)
HX_LOCAL_STACK_FRAME(_hx_pos_eb96856fbcf5bf72_57_list,"Lambda","list",0x9f7ad705,"Lambda.list","/home/kaiz0r/haxe/std/Lambda.hx",57,0x59846327)
HX_LOCAL_STACK_FRAME(_hx_pos_eb96856fbcf5bf72_70_map,"Lambda","map",0x3d8fa1d5,"Lambda.map","/home/kaiz0r/haxe/std/Lambda.hx",70,0x59846327)
HX_LOCAL_STACK_FRAME(_hx_pos_eb96856fbcf5bf72_78_mapi,"Lambda","mapi",0xa01df8f4,"Lambda.mapi","/home/kaiz0r/haxe/std/Lambda.hx",78,0x59846327)
HX_LOCAL_STACK_FRAME(_hx_pos_eb96856fbcf5bf72_88_flatten,"Lambda","flatten",0xc5a6d37d,"Lambda.flatten","/home/kaiz0r/haxe/std/Lambda.hx",88,0x59846327)
HX_LOCAL_STACK_FRAME(_hx_pos_eb96856fbcf5bf72_97_flatMap,"Lambda","flatMap",0xc589381c,"Lambda.flatMap","/home/kaiz0r/haxe/std/Lambda.hx",97,0x59846327)
HX_LOCAL_STACK_FRAME(_hx_pos_eb96856fbcf5bf72_108_has,"Lambda","has",0x3d8bd693,"Lambda.has","/home/kaiz0r/haxe/std/Lambda.hx",108,0x59846327)
HX_LOCAL_STACK_FRAME(_hx_pos_eb96856fbcf5bf72_125_exists,"Lambda","exists",0x65091043,"Lambda.exists","/home/kaiz0r/haxe/std/Lambda.hx",125,0x59846327)
HX_LOCAL_STACK_FRAME(_hx_pos_eb96856fbcf5bf72_144_foreach,"Lambda","foreach",0xb8902543,"Lambda.foreach","/home/kaiz0r/haxe/std/Lambda.hx",144,0x59846327)
HX_LOCAL_STACK_FRAME(_hx_pos_eb96856fbcf5bf72_157_iter,"Lambda","iter",0x9d877fbf,"Lambda.iter","/home/kaiz0r/haxe/std/Lambda.hx",157,0x59846327)
HX_LOCAL_STACK_FRAME(_hx_pos_eb96856fbcf5bf72_168_filter,"Lambda","filter",0x2a5e121f,"Lambda.filter","/home/kaiz0r/haxe/std/Lambda.hx",168,0x59846327)
HX_LOCAL_STACK_FRAME(_hx_pos_eb96856fbcf5bf72_183_fold,"Lambda","fold",0x9b8816a8,"Lambda.fold","/home/kaiz0r/haxe/std/Lambda.hx",183,0x59846327)
HX_LOCAL_STACK_FRAME(_hx_pos_eb96856fbcf5bf72_195_count,"Lambda","count",0xc15edc48,"Lambda.count","/home/kaiz0r/haxe/std/Lambda.hx",195,0x59846327)
HX_LOCAL_STACK_FRAME(_hx_pos_eb96856fbcf5bf72_211_empty,"Lambda","empty",0xe6d5d206,"Lambda.empty","/home/kaiz0r/haxe/std/Lambda.hx",211,0x59846327)
HX_LOCAL_STACK_FRAME(_hx_pos_eb96856fbcf5bf72_221_indexOf,"Lambda","indexOf",0xbf6a7082,"Lambda.indexOf","/home/kaiz0r/haxe/std/Lambda.hx",221,0x59846327)
HX_LOCAL_STACK_FRAME(_hx_pos_eb96856fbcf5bf72_241_find,"Lambda","find",0x9b838ae0,"Lambda.find","/home/kaiz0r/haxe/std/Lambda.hx",241,0x59846327)
HX_LOCAL_STACK_FRAME(_hx_pos_eb96856fbcf5bf72_255_concat,"Lambda","concat",0x6cf8fb7b,"Lambda.concat","/home/kaiz0r/haxe/std/Lambda.hx",255,0x59846327)
...
::cpp::VirtualArray Lambda_obj::array( ::Dynamic it){
            	HX_STACKFRAME(&_hx_pos_eb96856fbcf5bf72_45_array)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Lambda_obj,array,return )
 ...
 ::haxe::ds::List Lambda_obj::list( ::Dynamic it){
            	HX_GC_STACKFRAME(&_hx_pos_eb96856fbcf5bf72_57_list)
...
::cpp::VirtualArray Lambda_obj::map( ::Dynamic it, ::Dynamic f){
            	HX_STACKFRAME(&_hx_pos_eb96856fbcf5bf72_70_map)
...
::cpp::VirtualArray Lambda_obj::mapi( ::Dynamic it, ::Dynamic f){
            	HX_STACKFRAME(&_hx_pos_eb96856fbcf5bf72_78_mapi)
HXLINE(  79)		int i = 0;
...
::cpp::VirtualArray Lambda_obj::flatten( ::Dynamic it){
            	HX_STACKFRAME(&_hx_pos_eb96856fbcf5bf72_88_flatten)
...
::cpp::VirtualArray Lambda_obj::flatMap( ::Dynamic it, ::Dynamic f){
            	HX_STACKFRAME(&_hx_pos_eb96856fbcf5bf72_97_flatMap)
...
bool Lambda_obj::has( ::Dynamic it, ::Dynamic elt){
            	HX_STACKFRAME(&_hx_pos_eb96856fbcf5bf72_108_has)
HXLINE( 109)		{
...
bool Lambda_obj::exists( ::Dynamic it, ::Dynamic f){
            	HX_STACKFRAME(&_hx_pos_eb96856fbcf5bf72_125_exists)
HXLINE( 126)		{
...
bool Lambda_obj::foreach( ::Dynamic it, ::Dynamic f){
            	HX_STACKFRAME(&_hx_pos_eb96856fbcf5bf72_144_foreach)
HXLINE( 145)		{
...
void Lambda_obj::iter( ::Dynamic it, ::Dynamic f){
            	HX_STACKFRAME(&_hx_pos_eb96856fbcf5bf72_157_iter)
...
::cpp::VirtualArray Lambda_obj::filter( ::Dynamic it, ::Dynamic f){
            	HX_STACKFRAME(&_hx_pos_eb96856fbcf5bf72_168_filter)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Lambda_obj,filter,return )
 ...
 ::Dynamic Lambda_obj::fold( ::Dynamic it, ::Dynamic f, ::Dynamic first){
            	HX_STACKFRAME(&_hx_pos_eb96856fbcf5bf72_183_fold)
HXLINE( 184)		{
...
int Lambda_obj::count( ::Dynamic it, ::Dynamic pred){
            	HX_STACKFRAME(&_hx_pos_eb96856fbcf5bf72_195_count)
HXLINE( 196)		int n = 0;
HXLINE( 197)		if (hx::IsNull( pred )) {
HXLINE( 198)			 ::Dynamic _ = it->__Field(HX_("iterator",ee,49,9a,93),hx::paccDynamic)();
HXDLIN( 198)			while(( (bool)(_->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 198)				 ::Dynamic _1 = _->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)();
HXLINE( 199)				n = (n + 1);
            			}
            		}
            		else {
HXLINE( 201)			 ::Dynamic x = it->__Field(HX_("iterator",ee,49,9a,93),hx::paccDynamic)();
HXDLIN( 201)			while(( (bool)(x->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 201)				 ::Dynamic x1 = x->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)();
HXLINE( 202)				if (( (bool)(pred(x1)) )) {
HXLINE( 203)					n = (n + 1);
            				}
            			}
            		}
...
bool Lambda_obj::empty( ::Dynamic it){
            	HX_STACKFRAME(&_hx_pos_eb96856fbcf5bf72_211_empty)
HXDLIN( 211)		return !(( (bool)(it->__Field(HX_("iterator",ee,49,9a,93),hx::paccDynamic)()->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) ));
            	}
...
int Lambda_obj::indexOf( ::Dynamic it, ::Dynamic v){
            	HX_STACKFRAME(&_hx_pos_eb96856fbcf5bf72_221_indexOf)
HXLINE( 222)		int i = 0;
HXLINE( 223)		{
HXLINE( 223)			 ::Dynamic v2 = it->__Field(HX_("iterator",ee,49,9a,93),hx::paccDynamic)();
HXDLIN( 223)			while(( (bool)(v2->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 223)				 ::Dynamic v21 = v2->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)();
HXLINE( 224)				if (hx::IsEq( v,v21 )) {
HXLINE( 225)					return i;
            				}
HXLINE( 226)				i = (i + 1);
            			}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(Lambda_obj,indexOf,return )
 ...
 ::Dynamic Lambda_obj::find( ::Dynamic it, ::Dynamic f){
            	HX_STACKFRAME(&_hx_pos_eb96856fbcf5bf72_241_find)
HXLINE( 242)		{
HXLINE( 242)			 ::Dynamic v = it->__Field(HX_("iterator",ee,49,9a,93),hx::paccDynamic)();
HXDLIN( 242)			while(( (bool)(v->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 242)				 ::Dynamic v1 = v->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)();
HXLINE( 243)				if (( (bool)(f(v1)) )) {
HXLINE( 244)					return v1;
            				}
            			}
            		}
...
::cpp::VirtualArray Lambda_obj::concat( ::Dynamic a, ::Dynamic b){
            	HX_STACKFRAME(&_hx_pos_eb96856fbcf5bf72_255_concat)
HXLINE( 256)		::cpp::VirtualArray l = ::cpp::VirtualArray_obj::__new();
HXLINE( 257)		{
HXLINE( 257)			 ::Dynamic x = a->__Field(HX_("iterator",ee,49,9a,93),hx::paccDynamic)();
HXDLIN( 257)			while(( (bool)(x->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 257)				 ::Dynamic x1 = x->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)();
HXLINE( 258)				l->push(x1);
            			}
            		}
HXLINE( 259)		{
HXLINE( 259)			 ::Dynamic x2 = b->__Field(HX_("iterator",ee,49,9a,93),hx::paccDynamic)();
HXDLIN( 259)			while(( (bool)(x2->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 259)				 ::Dynamic x3 = x2->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)();
HXLINE( 260)				l->push(x3);
            			}
            		}
HXLINE( 261)		return l;
            	}
