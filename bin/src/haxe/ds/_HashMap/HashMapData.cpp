...
HX_DEFINE_STACK_FRAME(_hx_pos_86614a47e09e0a6c_107_new,"haxe.ds._HashMap.HashMapData","new",0x79117a62,"haxe.ds._HashMap.HashMapData.new","/home/kaiz0r/haxe/std/haxe/ds/HashMap.hx",107,0xac7c2bd7)
namespace haxe{
namespace ds{
namespace _HashMap{

void HashMapData_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_86614a47e09e0a6c_107_new)
HXLINE( 108)		this->keys =  ::haxe::ds::IntMap_obj::__alloc( HX_CTX );
HXLINE( 109)		this->values =  ::haxe::ds::IntMap_obj::__alloc( HX_CTX );
            	}
...
bool HashMapData_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x2eba8214;
}
