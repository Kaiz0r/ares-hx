...
HX_DEFINE_STACK_FRAME(_hx_pos_2c94b36697307260_78_new,"haxe.ds._GenericStack.GenericStackIterator","new",0xd4415186,"haxe.ds._GenericStack.GenericStackIterator.new","/home/kaiz0r/haxe/std/haxe/ds/GenericStack.hx",78,0x6dd1ac86)
HX_LOCAL_STACK_FRAME(_hx_pos_2c94b36697307260_68_hasNext,"haxe.ds._GenericStack.GenericStackIterator","hasNext",0x78c2b193,"haxe.ds._GenericStack.GenericStackIterator.hasNext","/home/kaiz0r/haxe/std/haxe/ds/GenericStack.hx",68,0x6dd1ac86)
HX_LOCAL_STACK_FRAME(_hx_pos_2c94b36697307260_71_next,"haxe.ds._GenericStack.GenericStackIterator","next",0xe4e6050d,"haxe.ds._GenericStack.GenericStackIterator.next","/home/kaiz0r/haxe/std/haxe/ds/GenericStack.hx",71,0x6dd1ac86)
namespace haxe{
namespace ds{
namespace _GenericStack{

void GenericStackIterator_obj::__construct( ::haxe::ds::GenericCell head){
            	HX_STACKFRAME(&_hx_pos_2c94b36697307260_78_new)
...
bool GenericStackIterator_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x64f013fa;
}

bool GenericStackIterator_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_2c94b36697307260_68_hasNext)
HXDLIN(  68)		return hx::IsNotNull( this->current );
            	}


 ::Dynamic GenericStackIterator_obj::next(){
            	HX_STACKFRAME(&_hx_pos_2c94b36697307260_71_next)
