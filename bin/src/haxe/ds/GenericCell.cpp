...
HX_DEFINE_STACK_FRAME(_hx_pos_353eee133911099b_37_new,"haxe.ds.GenericCell","new",0x14fd4914,"haxe.ds.GenericCell.new","/home/kaiz0r/haxe/std/haxe/ds/GenericStack.hx",37,0x6dd1ac86)
namespace haxe{
namespace ds{

void GenericCell_obj::__construct( ::Dynamic elt, ::haxe::ds::GenericCell next){
            	HX_STACKFRAME(&_hx_pos_353eee133911099b_37_new)
...
bool GenericCell_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x3b9875e4;
}
