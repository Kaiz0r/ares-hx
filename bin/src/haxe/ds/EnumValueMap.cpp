...
HX_DEFINE_STACK_FRAME(_hx_pos_a7cd178ae0d333de_31_new,"haxe.ds.EnumValueMap","new",0x9ce29655,"haxe.ds.EnumValueMap.new","/home/kaiz0r/haxe/std/haxe/ds/EnumValueMap.hx",31,0x6855514b)
HX_LOCAL_STACK_FRAME(_hx_pos_a7cd178ae0d333de_32_compare,"haxe.ds.EnumValueMap","compare",0x806a7d1a,"haxe.ds.EnumValueMap.compare","/home/kaiz0r/haxe/std/haxe/ds/EnumValueMap.hx",32,0x6855514b)
HX_LOCAL_STACK_FRAME(_hx_pos_a7cd178ae0d333de_43_compareArgs,"haxe.ds.EnumValueMap","compareArgs",0x37a5cb97,"haxe.ds.EnumValueMap.compareArgs","/home/kaiz0r/haxe/std/haxe/ds/EnumValueMap.hx",43,0x6855514b)
HX_LOCAL_STACK_FRAME(_hx_pos_a7cd178ae0d333de_56_compareArg,"haxe.ds.EnumValueMap","compareArg",0xcee2e55c,"haxe.ds.EnumValueMap.compareArg","/home/kaiz0r/haxe/std/haxe/ds/EnumValueMap.hx",56,0x6855514b)
HX_LOCAL_STACK_FRAME(_hx_pos_a7cd178ae0d333de_65_copy,"haxe.ds.EnumValueMap","copy",0xa2232c20,"haxe.ds.EnumValueMap.copy","/home/kaiz0r/haxe/std/haxe/ds/EnumValueMap.hx",65,0x6855514b)
namespace haxe{
namespace ds{

void EnumValueMap_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_a7cd178ae0d333de_31_new)
...
int EnumValueMap_obj::compare( ::Dynamic _tmp_k1, ::Dynamic _tmp_k2){
            	HX_STACKFRAME(&_hx_pos_a7cd178ae0d333de_32_compare)
...
int EnumValueMap_obj::compareArgs(::cpp::VirtualArray a1,::cpp::VirtualArray a2){
            	HX_STACKFRAME(&_hx_pos_a7cd178ae0d333de_43_compareArgs)
...
int EnumValueMap_obj::compareArg( ::Dynamic v1, ::Dynamic v2){
            	HX_STACKFRAME(&_hx_pos_a7cd178ae0d333de_56_compareArg)
...
HXDLIN(  58)			if (::Std_obj::is(v1,hx::ArrayBase::__mClass)) {
HXLINE(  58)				_hx_tmp1 = ::Std_obj::is(v2,hx::ArrayBase::__mClass);
            			}
            			else {
...
HX_DEFINE_DYNAMIC_FUNC2(EnumValueMap_obj,compareArg,return )
 ...
 ::haxe::ds::BalancedTree EnumValueMap_obj::copy(){
            	HX_GC_STACKFRAME(&_hx_pos_a7cd178ae0d333de_65_copy)
...
class EnumValueMap_obj__scriptable : public EnumValueMap_obj {
   ...
   HX_DEFINE_SCRIPTABLE(HX_ARR_LIST0)
	...
	}  else  EnumValueMap_obj::iteratorLoop(node,acc);}
	...
	if (__scriptVTable[20] ) {
		...
		__ctx->pushObject(v1);
		__ctx->pushObject(v2);
		return __ctx->runInt(__scriptVTable[20] );
