...
HX_DEFINE_STACK_FRAME(_hx_pos_d60bdde6f7cbd534_255_new,"haxe.ds.TreeNode","new",0x88d32f89,"haxe.ds.TreeNode.new","/home/kaiz0r/haxe/std/haxe/ds/BalancedTree.hx",255,0x90efa411)
HX_LOCAL_STACK_FRAME(_hx_pos_d60bdde6f7cbd534_270_toString,"haxe.ds.TreeNode","toString",0xcf78dce3,"haxe.ds.TreeNode.toString","/home/kaiz0r/haxe/std/haxe/ds/BalancedTree.hx",270,0x90efa411)
namespace haxe{
namespace ds{
...
void TreeNode_obj::__construct( ::haxe::ds::TreeNode l, ::Dynamic k, ::Dynamic v, ::haxe::ds::TreeNode r,hx::Null< int >  __o_h){
            	...
            	HX_STACKFRAME(&_hx_pos_d60bdde6f7cbd534_255_new)
HXLINE( 256)		this->left = l;
HXLINE( 257)		this->key = k;
HXLINE( 258)		this->value = v;
HXLINE( 259)		this->right = r;
HXLINE( 260)		if ((h == -1)) {
HXLINE( 261)			int _hx_tmp;
HXDLIN( 261)			 ::haxe::ds::TreeNode _this = this->left;
HXDLIN( 261)			int _hx_tmp1;
HXDLIN( 261)			if (hx::IsNull( _this )) {
HXLINE( 261)				_hx_tmp1 = 0;
            			}
            			else {
HXLINE( 261)				_hx_tmp1 = _this->_height;
            			}
HXDLIN( 261)			 ::haxe::ds::TreeNode _this1 = this->right;
HXDLIN( 261)			int _hx_tmp2;
HXDLIN( 261)			if (hx::IsNull( _this1 )) {
HXLINE( 261)				_hx_tmp2 = 0;
            			}
            			else {
HXLINE( 261)				_hx_tmp2 = _this1->_height;
            			}
HXDLIN( 261)			if ((_hx_tmp1 > _hx_tmp2)) {
HXLINE( 261)				 ::haxe::ds::TreeNode _this2 = this->left;
HXDLIN( 261)				if (hx::IsNull( _this2 )) {
HXLINE( 261)					_hx_tmp = 0;
            				}
            				else {
HXLINE( 261)					_hx_tmp = _this2->_height;
            				}
            			}
            			else {
HXLINE( 261)				 ::haxe::ds::TreeNode _this3 = this->right;
HXDLIN( 261)				if (hx::IsNull( _this3 )) {
HXLINE( 261)					_hx_tmp = 0;
            				}
            				else {
HXLINE( 261)					_hx_tmp = _this3->_height;
            				}
            			}
HXDLIN( 261)			this->_height = (_hx_tmp + 1);
            		}
            		else {
HXLINE( 263)			this->_height = h;
            		}
            	}
...
::String TreeNode_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_d60bdde6f7cbd534_270_toString)
HXDLIN( 270)		::String _hx_tmp;
HXDLIN( 270)		if (hx::IsNull( this->left )) {
HXDLIN( 270)			_hx_tmp = HX_("",00,00,00,00);
            		}
            		else {
HXDLIN( 270)			_hx_tmp = (this->left->toString() + HX_(", ",74,26,00,00));
            		}
HXDLIN( 270)		::String _hx_tmp1 = ((HX_("",00,00,00,00) + ::Std_obj::string(this->key)) + HX_("=",3d,00,00,00));
HXDLIN( 270)		::String _hx_tmp2 = (_hx_tmp + (_hx_tmp1 + ::Std_obj::string(this->value)));
HXDLIN( 270)		::String _hx_tmp3;
HXDLIN( 270)		if (hx::IsNull( this->right )) {
HXDLIN( 270)			_hx_tmp3 = HX_("",00,00,00,00);
            		}
            		else {
HXDLIN( 270)			_hx_tmp3 = (HX_(", ",74,26,00,00) + this->right->toString());
            		}
HXDLIN( 270)		return (_hx_tmp2 + _hx_tmp3);
            	}
