...
HX_DEFINE_STACK_FRAME(_hx_pos_b49b4309cf3e71bd_44_new,"haxe.xml.Printer","new",0x896dce4d,"haxe.xml.Printer.new","/home/kaiz0r/haxe/std/haxe/xml/Printer.hx",44,0x55cfb5f5)
HX_LOCAL_STACK_FRAME(_hx_pos_b49b4309cf3e71bd_50_writeNode,"haxe.xml.Printer","writeNode",0x6952ac2e,"haxe.xml.Printer.writeNode","/home/kaiz0r/haxe/std/haxe/xml/Printer.hx",50,0x55cfb5f5)
...
HX_LOCAL_STACK_FRAME(_hx_pos_b49b4309cf3e71bd_114_hasChildren,"haxe.xml.Printer","hasChildren",0xeb7e31a6,"haxe.xml.Printer.hasChildren","/home/kaiz0r/haxe/std/haxe/xml/Printer.hx",114,0x55cfb5f5)
HX_LOCAL_STACK_FRAME(_hx_pos_b49b4309cf3e71bd_35_print,"haxe.xml.Printer","print",0x4a926b5a,"haxe.xml.Printer.print","/home/kaiz0r/haxe/std/haxe/xml/Printer.hx",35,0x55cfb5f5)
namespace haxe{
namespace xml{

void Printer_obj::__construct(bool pretty){
            	HX_GC_STACKFRAME(&_hx_pos_b49b4309cf3e71bd_44_new)
...
void Printer_obj::writeNode( ::Xml value,::String tabs){
            	HX_GC_STACKFRAME(&_hx_pos_b49b4309cf3e71bd_50_writeNode)
...
bool Printer_obj::hasChildren( ::Xml value){
            	HX_STACKFRAME(&_hx_pos_b49b4309cf3e71bd_114_hasChildren)
HXLINE( 115)		{
...
HXLINE( 120)							HX_STACK_DO_THROW((HX_("Bad node type, unexpected ",be,79,d5,11) + ::_Xml::XmlType_Impl__obj::toString(child1->nodeType)));
            						}
HXDLIN( 120)						if ((::StringTools_obj::ltrim(child1->nodeValue).length != 0)) {
...
::String Printer_obj::print( ::Xml xml, ::Dynamic __o_pretty){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_b49b4309cf3e71bd_35_print)
