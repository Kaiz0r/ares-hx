...
HX_LOCAL_STACK_FRAME(_hx_pos_d0498bd845071481_44_parse,"haxe.Json","parse",0x396f54d5,"haxe.Json.parse","/home/kaiz0r/haxe/std/haxe/Json.hx",44,0xebeff81d)
HX_LOCAL_STACK_FRAME(_hx_pos_d0498bd845071481_60_stringify,"haxe.Json","stringify",0x9504336d,"haxe.Json.stringify","/home/kaiz0r/haxe/std/haxe/Json.hx",60,0xebeff81d)
namespace haxe{
...
bool Json_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x0a88d5ae;
}

 ::Dynamic Json_obj::parse(::String text){
            	HX_GC_STACKFRAME(&_hx_pos_d0498bd845071481_44_parse)
...
::String Json_obj::stringify( ::Dynamic value, ::Dynamic replacer,::String space){
            	HX_STACKFRAME(&_hx_pos_d0498bd845071481_60_stringify)
