...
HX_DEFINE_STACK_FRAME(_hx_pos_3634f8df8fb73527_35_new,"haxe.iterators.MapKeyValueIterator","new",0x902a97fd,"haxe.iterators.MapKeyValueIterator.new","/home/kaiz0r/haxe/std/haxe/iterators/MapKeyValueIterator.hx",35,0x2af82005)
HX_LOCAL_STACK_FRAME(_hx_pos_3634f8df8fb73527_44_hasNext,"haxe.iterators.MapKeyValueIterator","hasNext",0x6e75ff8a,"haxe.iterators.MapKeyValueIterator.hasNext","/home/kaiz0r/haxe/std/haxe/iterators/MapKeyValueIterator.hx",44,0x2af82005)
HX_LOCAL_STACK_FRAME(_hx_pos_3634f8df8fb73527_50_next,"haxe.iterators.MapKeyValueIterator","next",0x951a66b6,"haxe.iterators.MapKeyValueIterator.next","/home/kaiz0r/haxe/std/haxe/iterators/MapKeyValueIterator.hx",50,0x2af82005)
namespace haxe{
namespace iterators{

void MapKeyValueIterator_obj::__construct(::Dynamic map){
            	HX_STACKFRAME(&_hx_pos_3634f8df8fb73527_35_new)
...
bool MapKeyValueIterator_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x7cff4d3d;
}

bool MapKeyValueIterator_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_3634f8df8fb73527_44_hasNext)
...
HX_DEFINE_DYNAMIC_FUNC0(MapKeyValueIterator_obj,hasNext,return )
 ...
 ::Dynamic MapKeyValueIterator_obj::next(){
            	HX_STACKFRAME(&_hx_pos_3634f8df8fb73527_50_next)
