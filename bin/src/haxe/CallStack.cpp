...
HX_LOCAL_STACK_FRAME(_hx_pos_8f661699abf8e62a_94_callStack,"haxe.CallStack","callStack",0xfa9165be,"haxe.CallStack.callStack","/home/kaiz0r/haxe/std/haxe/CallStack.hx",94,0x1584034d)
HX_LOCAL_STACK_FRAME(_hx_pos_8f661699abf8e62a_259_toString,"haxe.CallStack","toString",0xd59be738,"haxe.CallStack.toString","/home/kaiz0r/haxe/std/haxe/CallStack.hx",259,0x1584034d)
static const ::String _hx_array_data_6d544b62_3[] = {
	HX_("\nCalled from ",bd,26,6b,81),
};
HX_LOCAL_STACK_FRAME(_hx_pos_8f661699abf8e62a_269_itemToString,"haxe.CallStack","itemToString",0xc121696b,"haxe.CallStack.itemToString","/home/kaiz0r/haxe/std/haxe/CallStack.hx",269,0x1584034d)
...
::Array< ::Dynamic> CallStack_obj::callStack(){
            	HX_STACKFRAME(&_hx_pos_8f661699abf8e62a_94_callStack)
...
::String CallStack_obj::toString(::Array< ::Dynamic> stack){
            	HX_GC_STACKFRAME(&_hx_pos_8f661699abf8e62a_259_toString)
...
HXLINE( 262)						b->b = ::Array_obj< ::String >::fromData( _hx_array_data_6d544b62_3,1);
            					}
            					else {
...
void CallStack_obj::itemToString( ::StringBuf b, ::haxe::StackItem s){
            	HX_STACKFRAME(&_hx_pos_8f661699abf8e62a_269_itemToString)
...
HXLINE( 271)					b->b = ::Array_obj< ::String >::fromData( _hx_array_data_6d544b62_5,1);
            				}
            				else {
...
HXLINE( 273)							b->b = ::Array_obj< ::String >::fromData( _hx_array_data_6d544b62_6,1);
            						}
            						else {
...
HXLINE( 278)								b->b = ::Array_obj< ::String >::fromData( _hx_array_data_6d544b62_7,1);
            							}
            							else {
...
HXLINE( 281)							b->b = ::Array_obj< ::String >::fromData( _hx_array_data_6d544b62_8,1);
            						}
            						else {
...
HXLINE( 284)								b->b = ::Array_obj< ::String >::fromData( _hx_array_data_6d544b62_9,1);
            							}
            							else {
...
HXLINE( 288)							b->b = ::Array_obj< ::String >::fromData( _hx_array_data_6d544b62_10,1);
            						}
            						else {
...
HXLINE( 291)							b->b = ::Array_obj< ::String >::fromData( _hx_array_data_6d544b62_11,1);
            						}
            						else {
...
HXLINE( 294)							b->b = ::Array_obj< ::String >::fromData( _hx_array_data_6d544b62_12,1);
            						}
            						else {
...
class CallStack_obj__scriptable : public CallStack_obj {
   typedef CallStack_obj__scriptable __ME;
   typedef CallStack_obj super;
   typedef CallStack_obj::super __superString;
...
ctx->returnObject(CallStack_obj::callStack());
}

static void CPPIA_CALL __s_exceptionStack(hx::CppiaCtx *ctx) {
ctx->returnObject(CallStack_obj::exceptionStack());
}

static void CPPIA_CALL __s_toString(hx::CppiaCtx *ctx) {
ctx->returnString(CallStack_obj::toString(ctx->getObject(sizeof(void*))));
}

static void CPPIA_CALL __s_itemToString(hx::CppiaCtx *ctx) {
CallStack_obj::itemToString(ctx->getObject(sizeof(void*)),ctx->getObject(sizeof(void*)+sizeof(void *)));
}

static void CPPIA_CALL __s_makeStack(hx::CppiaCtx *ctx) {
ctx->returnObject(CallStack_obj::makeStack(ctx->getObject(sizeof(void*))));
}
...
static hx::ScriptNamedFunction __scriptableFunctions[] = {
  ...
  hx::ScriptNamedFunction("toString",__s_toString,"so", true HXCPP_CPPIA_SUPER_ARG(0) ),
  hx::ScriptNamedFunction("itemToString",__s_itemToString,"voo", true HXCPP_CPPIA_SUPER_ARG(0) ),
  hx::ScriptNamedFunction("makeStack",__s_makeStack,"oo", true HXCPP_CPPIA_SUPER_ARG(0) ),
  hx::ScriptNamedFunction(0,0,0 HXCPP_CPPIA_SUPER_ARG(0) ) };
hx::Class CallStack_obj::__mClass;

hx::ScriptFunction CallStack_obj::__script_construct(0,0);
...
void CallStack_obj::__register()
{
  ...
  HX_SCRIPTABLE_REGISTER_CLASS("haxe.CallStack",CallStack_obj);
}
