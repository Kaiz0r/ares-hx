...
HX_DEFINE_STACK_FRAME(_hx_pos_93785e9dacdac46d_48_new,"haxe.crypto.Sha1","new",0xdb44b09c,"haxe.crypto.Sha1.new","/home/kaiz0r/haxe/std/haxe/crypto/Sha1.hx",48,0xbe25d964)
HX_LOCAL_STACK_FRAME(_hx_pos_93785e9dacdac46d_50_doEncode,"haxe.crypto.Sha1","doEncode",0xfb483e45,"haxe.crypto.Sha1.doEncode","/home/kaiz0r/haxe/std/haxe/crypto/Sha1.hx",50,0xbe25d964)
HX_LOCAL_STACK_FRAME(_hx_pos_93785e9dacdac46d_136_rol,"haxe.crypto.Sha1","rol",0xdb47c24b,"haxe.crypto.Sha1.rol","/home/kaiz0r/haxe/std/haxe/crypto/Sha1.hx",136,0xbe25d964)
HX_LOCAL_STACK_FRAME(_hx_pos_93785e9dacdac46d_142_ft,"haxe.crypto.Sha1","ft",0x7aab5492,"haxe.crypto.Sha1.ft","/home/kaiz0r/haxe/std/haxe/crypto/Sha1.hx",142,0xbe25d964)
HX_LOCAL_STACK_FRAME(_hx_pos_93785e9dacdac46d_155_kt,"haxe.crypto.Sha1","kt",0x7aab58ed,"haxe.crypto.Sha1.kt","/home/kaiz0r/haxe/std/haxe/crypto/Sha1.hx",155,0xbe25d964)
HX_LOCAL_STACK_FRAME(_hx_pos_93785e9dacdac46d_165_hex,"haxe.crypto.Sha1","hex",0xdb402317,"haxe.crypto.Sha1.hex","/home/kaiz0r/haxe/std/haxe/crypto/Sha1.hx",165,0xbe25d964)
HX_LOCAL_STACK_FRAME(_hx_pos_93785e9dacdac46d_29_encode,"haxe.crypto.Sha1","encode",0xcc67df5a,"haxe.crypto.Sha1.encode","/home/kaiz0r/haxe/std/haxe/crypto/Sha1.hx",29,0xbe25d964)
HX_LOCAL_STACK_FRAME(_hx_pos_93785e9dacdac46d_35_make,"haxe.crypto.Sha1","make",0x00298e32,"haxe.crypto.Sha1.make","/home/kaiz0r/haxe/std/haxe/crypto/Sha1.hx",35,0xbe25d964)
HX_LOCAL_STACK_FRAME(_hx_pos_93785e9dacdac46d_95_str2blks,"haxe.crypto.Sha1","str2blks",0x96813717,"haxe.crypto.Sha1.str2blks","/home/kaiz0r/haxe/std/haxe/crypto/Sha1.hx",95,0xbe25d964)
HX_LOCAL_STACK_FRAME(_hx_pos_93785e9dacdac46d_115_bytes2blks,"haxe.crypto.Sha1","bytes2blks",0x985aae1d,"haxe.crypto.Sha1.bytes2blks","/home/kaiz0r/haxe/std/haxe/crypto/Sha1.hx",115,0xbe25d964)
namespace haxe{
namespace crypto{

void Sha1_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_93785e9dacdac46d_48_new)
            	}
...
bool Sha1_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x7b0365a8;
}

::Array< int > Sha1_obj::doEncode(::Array< int > x){
            	HX_STACKFRAME(&_hx_pos_93785e9dacdac46d_50_doEncode)
...
int Sha1_obj::rol(int num,int cnt){
            	HX_STACKFRAME(&_hx_pos_93785e9dacdac46d_136_rol)
...
int Sha1_obj::ft(int t,int b,int c,int d){
            	HX_STACKFRAME(&_hx_pos_93785e9dacdac46d_142_ft)
HXLINE( 143)		if ((t < 20)) {
...
int Sha1_obj::kt(int t){
            	HX_STACKFRAME(&_hx_pos_93785e9dacdac46d_155_kt)
HXLINE( 156)		if ((t < 20)) {
...
::String Sha1_obj::hex(::Array< int > a){
            	HX_STACKFRAME(&_hx_pos_93785e9dacdac46d_165_hex)
...
::String Sha1_obj::encode(::String s){
            	HX_GC_STACKFRAME(&_hx_pos_93785e9dacdac46d_29_encode)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Sha1_obj,encode,return )
 ...
 ::haxe::io::Bytes Sha1_obj::make( ::haxe::io::Bytes b){
            	HX_GC_STACKFRAME(&_hx_pos_93785e9dacdac46d_35_make)
...
::Array< int > Sha1_obj::str2blks(::String s){
            	HX_STACKFRAME(&_hx_pos_93785e9dacdac46d_95_str2blks)
...
HXDLIN( 104)				int i1 = (_g2 - 1);
HXLINE( 105)				int p = (i1 >> 2);
HXLINE( 106)				::Array< int > blks1 = blks;
HXDLIN( 106)				int p1 = p;
HXDLIN( 106)				blks1[p1] = (blks1->__get(p1) | (( (int)(s1->b->__get(i1)) ) << (24 - ((i1 & 3) << 3))));
            			}
            		}
HXLINE( 108)		int i2 = s1->length;
HXLINE( 109)		int p2 = (i2 >> 2);
HXLINE( 110)		::Array< int > blks2 = blks;
HXDLIN( 110)		int p3 = p2;
HXDLIN( 110)		blks2[p3] = (blks2->__get(p3) | (128 << (24 - ((i2 & 3) << 3))));
...
::Array< int > Sha1_obj::bytes2blks( ::haxe::io::Bytes b){
            	HX_STACKFRAME(&_hx_pos_93785e9dacdac46d_115_bytes2blks)
