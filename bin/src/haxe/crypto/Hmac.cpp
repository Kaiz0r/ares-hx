...
HX_DEFINE_STACK_FRAME(_hx_pos_f0bf06b081fe8773_42_new,"haxe.crypto.Hmac","new",0x000e1c3e,"haxe.crypto.Hmac.new","/home/kaiz0r/haxe/std/haxe/crypto/Hmac.hx",42,0x158f3802)
HX_LOCAL_STACK_FRAME(_hx_pos_f0bf06b081fe8773_55_doHash,"haxe.crypto.Hmac","doHash",0x4b4fc7db,"haxe.crypto.Hmac.doHash","/home/kaiz0r/haxe/std/haxe/crypto/Hmac.hx",55,0x158f3802)
HX_LOCAL_STACK_FRAME(_hx_pos_f0bf06b081fe8773_62_nullPad,"haxe.crypto.Hmac","nullPad",0x62118bea,"haxe.crypto.Hmac.nullPad","/home/kaiz0r/haxe/std/haxe/crypto/Hmac.hx",62,0x158f3802)
HX_LOCAL_STACK_FRAME(_hx_pos_f0bf06b081fe8773_73_make,"haxe.crypto.Hmac","make",0x0b9e5050,"haxe.crypto.Hmac.make","/home/kaiz0r/haxe/std/haxe/crypto/Hmac.hx",73,0x158f3802)
namespace haxe{
namespace crypto{

void Hmac_obj::__construct( ::haxe::crypto::HashMethod hashMethod){
            	HX_STACKFRAME(&_hx_pos_f0bf06b081fe8773_42_new)
...
bool Hmac_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x7aa5eee6;
}

 ::haxe::io::Bytes Hmac_obj::doHash( ::haxe::io::Bytes b){
            	HX_STACKFRAME(&_hx_pos_f0bf06b081fe8773_55_doHash)
...
HX_DEFINE_DYNAMIC_FUNC1(Hmac_obj,doHash,return )
 ...
 ::haxe::io::Bytes Hmac_obj::nullPad( ::haxe::io::Bytes s,int chunkLen){
            	HX_GC_STACKFRAME(&_hx_pos_f0bf06b081fe8773_62_nullPad)
...
HXLINE(  68)		{
HXLINE(  68)			int _g2 = 0;
HXDLIN(  68)			int _g11 = r;
HXDLIN(  68)			while((_g2 < _g11)){
HXLINE(  68)				_g2 = (_g2 + 1);
...
HX_DEFINE_DYNAMIC_FUNC2(Hmac_obj,nullPad,return )
 ...
 ::haxe::io::Bytes Hmac_obj::make( ::haxe::io::Bytes key, ::haxe::io::Bytes msg){
            	HX_GC_STACKFRAME(&_hx_pos_f0bf06b081fe8773_73_make)
...
HXDLIN(  86)			{
HXLINE(  86)				int _g2 = 0;
HXDLIN(  86)				int _g11 = msg->length;
HXDLIN(  86)				while((_g2 < _g11)){
HXLINE(  86)					_g2 = (_g2 + 1);
HXDLIN(  86)					int i1 = (_g2 - 1);
HXDLIN(  86)					Ki->b->push(b2->__get(i1));
            				}
            			}
            		}
HXLINE(  87)		{
...
HXDLIN(  87)			{
HXLINE(  87)				int _g3 = 0;
HXDLIN(  87)				int _g12 = src->length;
HXDLIN(  87)				while((_g3 < _g12)){
HXLINE(  87)					_g3 = (_g3 + 1);
HXDLIN(  87)					int i2 = (_g3 - 1);
HXDLIN(  87)					Ko->b->push(b21->__get(i2));
            				}
            			}
            		}
