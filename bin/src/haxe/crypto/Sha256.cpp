...
HX_DEFINE_STACK_FRAME(_hx_pos_098a906bf74d311d_48_new,"haxe.crypto.Sha256","new",0x4d8a58be,"haxe.crypto.Sha256.new","/home/kaiz0r/haxe/std/haxe/crypto/Sha256.hx",48,0x433eef82)
HX_LOCAL_STACK_FRAME(_hx_pos_098a906bf74d311d_50_doEncode,"haxe.crypto.Sha256","doEncode",0xbba3dae3,"haxe.crypto.Sha256.doEncode","/home/kaiz0r/haxe/std/haxe/crypto/Sha256.hx",50,0x433eef82)
...
HX_LOCAL_STACK_FRAME(_hx_pos_098a906bf74d311d_188_hex,"haxe.crypto.Sha256","hex",0x4d85cb39,"haxe.crypto.Sha256.hex","/home/kaiz0r/haxe/std/haxe/crypto/Sha256.hx",188,0x433eef82)
HX_LOCAL_STACK_FRAME(_hx_pos_098a906bf74d311d_29_encode,"haxe.crypto.Sha256","encode",0x75947878,"haxe.crypto.Sha256.encode","/home/kaiz0r/haxe/std/haxe/crypto/Sha256.hx",29,0x433eef82)
HX_LOCAL_STACK_FRAME(_hx_pos_098a906bf74d311d_35_make,"haxe.crypto.Sha256","make",0x8ad703d0,"haxe.crypto.Sha256.make","/home/kaiz0r/haxe/std/haxe/crypto/Sha256.hx",35,0x433eef82)
HX_LOCAL_STACK_FRAME(_hx_pos_098a906bf74d311d_113_str2blks,"haxe.crypto.Sha256","str2blks",0x56dcd3b5,"haxe.crypto.Sha256.str2blks","/home/kaiz0r/haxe/std/haxe/crypto/Sha256.hx",113,0x433eef82)
HX_LOCAL_STACK_FRAME(_hx_pos_098a906bf74d311d_133_bytes2blks,"haxe.crypto.Sha256","bytes2blks",0xdc4d2e3b,"haxe.crypto.Sha256.bytes2blks","/home/kaiz0r/haxe/std/haxe/crypto/Sha256.hx",133,0x433eef82)
namespace haxe{
namespace crypto{

void Sha256_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_098a906bf74d311d_48_new)
            	}
...
bool Sha256_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x2d8e7ed2;
}

::Array< int > Sha256_obj::doEncode(::Array< int > m,int l){
            	HX_STACKFRAME(&_hx_pos_098a906bf74d311d_50_doEncode)
...
HXDLIN(  68)		int _hx_tmp = (l >> 5);
HXDLIN(  68)		m1[_hx_tmp] = (m1->__get(_hx_tmp) | (128 << (24 - hx::Mod(l,32))));
...
::String Sha256_obj::hex(::Array< int > a){
            	HX_STACKFRAME(&_hx_pos_098a906bf74d311d_188_hex)
...
::String Sha256_obj::encode(::String s){
            	HX_GC_STACKFRAME(&_hx_pos_098a906bf74d311d_29_encode)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Sha256_obj,encode,return )
 ...
 ::haxe::io::Bytes Sha256_obj::make( ::haxe::io::Bytes b){
            	HX_GC_STACKFRAME(&_hx_pos_098a906bf74d311d_35_make)
...
::Array< int > Sha256_obj::str2blks(::String s){
            	HX_STACKFRAME(&_hx_pos_098a906bf74d311d_113_str2blks)
...
HXDLIN( 122)				int i1 = (_g2 - 1);
HXLINE( 123)				int p = (i1 >> 2);
HXLINE( 124)				::Array< int > blks1 = blks;
HXDLIN( 124)				int p1 = p;
HXDLIN( 124)				blks1[p1] = (blks1->__get(p1) | (( (int)(s1->b->__get(i1)) ) << (24 - ((i1 & 3) << 3))));
            			}
            		}
HXLINE( 126)		int i2 = s1->length;
HXLINE( 127)		int p2 = (i2 >> 2);
HXLINE( 128)		::Array< int > blks2 = blks;
HXDLIN( 128)		int p3 = p2;
HXDLIN( 128)		blks2[p3] = (blks2->__get(p3) | (128 << (24 - ((i2 & 3) << 3))));
...
::Array< int > Sha256_obj::bytes2blks( ::haxe::io::Bytes b){
            	HX_STACKFRAME(&_hx_pos_098a906bf74d311d_133_bytes2blks)
