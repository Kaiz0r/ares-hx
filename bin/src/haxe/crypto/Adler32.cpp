...
HX_DEFINE_STACK_FRAME(_hx_pos_990a96b67378882d_32_new,"haxe.crypto.Adler32","new",0xc900c8e2,"haxe.crypto.Adler32.new","/home/kaiz0r/haxe/std/haxe/crypto/Adler32.hx",32,0x2ccc2fbe)
HX_LOCAL_STACK_FRAME(_hx_pos_990a96b67378882d_38_get,"haxe.crypto.Adler32","get",0xc8fb7918,"haxe.crypto.Adler32.get","/home/kaiz0r/haxe/std/haxe/crypto/Adler32.hx",38,0x2ccc2fbe)
HX_LOCAL_STACK_FRAME(_hx_pos_990a96b67378882d_41_update,"haxe.crypto.Adler32","update",0xb4b14ac7,"haxe.crypto.Adler32.update","/home/kaiz0r/haxe/std/haxe/crypto/Adler32.hx",41,0x2ccc2fbe)
HX_LOCAL_STACK_FRAME(_hx_pos_990a96b67378882d_53_equals,"haxe.crypto.Adler32","equals",0xed9eb2fd,"haxe.crypto.Adler32.equals","/home/kaiz0r/haxe/std/haxe/crypto/Adler32.hx",53,0x2ccc2fbe)
HX_LOCAL_STACK_FRAME(_hx_pos_990a96b67378882d_57_toString,"haxe.crypto.Adler32","toString",0xfc23c0ea,"haxe.crypto.Adler32.toString","/home/kaiz0r/haxe/std/haxe/crypto/Adler32.hx",57,0x2ccc2fbe)
HX_LOCAL_STACK_FRAME(_hx_pos_990a96b67378882d_60_read,"haxe.crypto.Adler32","read",0x1a53c494,"haxe.crypto.Adler32.read","/home/kaiz0r/haxe/std/haxe/crypto/Adler32.hx",60,0x2ccc2fbe)
HX_LOCAL_STACK_FRAME(_hx_pos_990a96b67378882d_71_make,"haxe.crypto.Adler32","make",0x1702b32c,"haxe.crypto.Adler32.make","/home/kaiz0r/haxe/std/haxe/crypto/Adler32.hx",71,0x2ccc2fbe)
namespace haxe{
namespace crypto{

void Adler32_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_990a96b67378882d_32_new)
HXLINE(  33)		this->a1 = 1;
HXLINE(  34)		this->a2 = 0;
            	}
...
int Adler32_obj::get(){
            	HX_STACKFRAME(&_hx_pos_990a96b67378882d_38_get)
...
void Adler32_obj::update( ::haxe::io::Bytes b,int pos,int len){
            	HX_STACKFRAME(&_hx_pos_990a96b67378882d_41_update)
...
bool Adler32_obj::equals( ::haxe::crypto::Adler32 a){
            	HX_STACKFRAME(&_hx_pos_990a96b67378882d_53_equals)
...
::String Adler32_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_990a96b67378882d_57_toString)
...
HX_DEFINE_DYNAMIC_FUNC0(Adler32_obj,toString,return )
 ...
 ::haxe::crypto::Adler32 Adler32_obj::read( ::haxe::io::Input i){
            	HX_GC_STACKFRAME(&_hx_pos_990a96b67378882d_60_read)
...
int Adler32_obj::make( ::haxe::io::Bytes b){
            	HX_GC_STACKFRAME(&_hx_pos_990a96b67378882d_71_make)
