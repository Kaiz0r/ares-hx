...
HX_DEFINE_STACK_FRAME(_hx_pos_62384a7ccc108302_39_new,"haxe.io.BytesInput","new",0x7fa18571,"haxe.io.BytesInput.new","/home/kaiz0r/haxe/std/haxe/io/BytesInput.hx",39,0x17eff5af)
HX_LOCAL_STACK_FRAME(_hx_pos_62384a7ccc108302_71_get_position,"haxe.io.BytesInput","get_position",0x9ad9f581,"haxe.io.BytesInput.get_position","/home/kaiz0r/haxe/std/haxe/io/BytesInput.hx",71,0x17eff5af)
HX_LOCAL_STACK_FRAME(_hx_pos_62384a7ccc108302_79_get_length,"haxe.io.BytesInput","get_length",0xbaeb83be,"haxe.io.BytesInput.get_length","/home/kaiz0r/haxe/std/haxe/io/BytesInput.hx",79,0x17eff5af)
HX_LOCAL_STACK_FRAME(_hx_pos_62384a7ccc108302_83_set_position,"haxe.io.BytesInput","set_position",0xafd318f5,"haxe.io.BytesInput.set_position","/home/kaiz0r/haxe/std/haxe/io/BytesInput.hx",83,0x17eff5af)
HX_LOCAL_STACK_FRAME(_hx_pos_62384a7ccc108302_96_readByte,"haxe.io.BytesInput","readByte",0xb70e46cd,"haxe.io.BytesInput.readByte","/home/kaiz0r/haxe/std/haxe/io/BytesInput.hx",96,0x17eff5af)
HX_LOCAL_STACK_FRAME(_hx_pos_62384a7ccc108302_119_readBytes,"haxe.io.BytesInput","readBytes",0x756fad06,"haxe.io.BytesInput.readBytes","/home/kaiz0r/haxe/std/haxe/io/BytesInput.hx",119,0x17eff5af)
namespace haxe{
namespace io{

void BytesInput_obj::__construct( ::haxe::io::Bytes b, ::Dynamic pos, ::Dynamic len){
            	HX_STACKFRAME(&_hx_pos_62384a7ccc108302_39_new)
...
int BytesInput_obj::get_position(){
            	HX_STACKFRAME(&_hx_pos_62384a7ccc108302_71_get_position)
...
int BytesInput_obj::get_length(){
            	HX_STACKFRAME(&_hx_pos_62384a7ccc108302_79_get_length)
...
int BytesInput_obj::set_position(int p){
            	HX_STACKFRAME(&_hx_pos_62384a7ccc108302_83_set_position)
HXLINE(  84)		if ((p < 0)) {
HXLINE(  85)			p = 0;
            		}
            		else {
...
int BytesInput_obj::readByte(){
            	HX_GC_STACKFRAME(&_hx_pos_62384a7ccc108302_96_readByte)
...
int BytesInput_obj::readBytes( ::haxe::io::Bytes buf,int pos,int len){
            	HX_GC_STACKFRAME(&_hx_pos_62384a7ccc108302_119_readBytes)
