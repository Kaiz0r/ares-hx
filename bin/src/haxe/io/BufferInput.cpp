...
HX_DEFINE_STACK_FRAME(_hx_pos_18080edb161f3e9c_31_new,"haxe.io.BufferInput","new",0x1ee6877c,"haxe.io.BufferInput.new","/home/kaiz0r/haxe/std/haxe/io/BufferInput.hx",31,0x1a43f6e4)
HX_LOCAL_STACK_FRAME(_hx_pos_18080edb161f3e9c_38_refill,"haxe.io.BufferInput","refill",0xd11f2a1a,"haxe.io.BufferInput.refill","/home/kaiz0r/haxe/std/haxe/io/BufferInput.hx",38,0x1a43f6e4)
HX_LOCAL_STACK_FRAME(_hx_pos_18080edb161f3e9c_46_readByte,"haxe.io.BufferInput","readByte",0xba4efce2,"haxe.io.BufferInput.readByte","/home/kaiz0r/haxe/std/haxe/io/BufferInput.hx",46,0x1a43f6e4)
HX_LOCAL_STACK_FRAME(_hx_pos_18080edb161f3e9c_55_readBytes,"haxe.io.BufferInput","readBytes",0x4ace4951,"haxe.io.BufferInput.readBytes","/home/kaiz0r/haxe/std/haxe/io/BufferInput.hx",55,0x1a43f6e4)
namespace haxe{
namespace io{
...
void BufferInput_obj::__construct( ::haxe::io::Input i, ::haxe::io::Bytes buf, ::Dynamic __o_pos, ::Dynamic __o_available){
            	...
            	HX_STACKFRAME(&_hx_pos_18080edb161f3e9c_31_new)
HXLINE(  32)		this->i = i;
...
bool BufferInput_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x3996a0f6) {
		return inClassId==(int)0x00000001 || inClassId==(int)0x3996a0f6;
	} else {
...
void BufferInput_obj::refill(){
            	HX_STACKFRAME(&_hx_pos_18080edb161f3e9c_38_refill)
...
int BufferInput_obj::readByte(){
            	HX_STACKFRAME(&_hx_pos_18080edb161f3e9c_46_readByte)
...
int BufferInput_obj::readBytes( ::haxe::io::Bytes buf,int pos,int len){
            	HX_STACKFRAME(&_hx_pos_18080edb161f3e9c_55_readBytes)
