...
HX_DEFINE_STACK_FRAME(_hx_pos_174d1c56753c9e1a_484_new,"haxe._Unserializer.NullResolver","new",0x49a2304b,"haxe._Unserializer.NullResolver.new","/home/kaiz0r/haxe/std/haxe/Unserializer.hx",484,0x8879c6fa)
HX_LOCAL_STACK_FRAME(_hx_pos_174d1c56753c9e1a_487_resolveClass,"haxe._Unserializer.NullResolver","resolveClass",0xc4a78861,"haxe._Unserializer.NullResolver.resolveClass","/home/kaiz0r/haxe/std/haxe/Unserializer.hx",487,0x8879c6fa)
HX_LOCAL_STACK_FRAME(_hx_pos_174d1c56753c9e1a_490_resolveEnum,"haxe._Unserializer.NullResolver","resolveEnum",0x5f3252f8,"haxe._Unserializer.NullResolver.resolveEnum","/home/kaiz0r/haxe/std/haxe/Unserializer.hx",490,0x8879c6fa)
HX_LOCAL_STACK_FRAME(_hx_pos_174d1c56753c9e1a_494_get_instance,"haxe._Unserializer.NullResolver","get_instance",0x52c49e53,"haxe._Unserializer.NullResolver.get_instance","/home/kaiz0r/haxe/std/haxe/Unserializer.hx",494,0x8879c6fa)
namespace haxe{
namespace _Unserializer{

void NullResolver_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_174d1c56753c9e1a_484_new)
            	}
...
hx::Class NullResolver_obj::resolveClass(::String name){
            	HX_STACKFRAME(&_hx_pos_174d1c56753c9e1a_487_resolveClass)
...
hx::Class NullResolver_obj::resolveEnum(::String name){
            	HX_STACKFRAME(&_hx_pos_174d1c56753c9e1a_490_resolveEnum)
...
HX_DEFINE_DYNAMIC_FUNC1(NullResolver_obj,resolveEnum,return )
 ...
 ::haxe::_Unserializer::NullResolver NullResolver_obj::get_instance(){
            	HX_GC_STACKFRAME(&_hx_pos_174d1c56753c9e1a_494_get_instance)
HXLINE( 495)		if (hx::IsNull( ::haxe::_Unserializer::NullResolver_obj::instance )) {
HXLINE( 496)			::haxe::_Unserializer::NullResolver_obj::instance =  ::haxe::_Unserializer::NullResolver_obj::__alloc( HX_CTX );
            		}
HXLINE( 497)		return ::haxe::_Unserializer::NullResolver_obj::instance;
            	}
