...
HX_LOCAL_STACK_FRAME(_hx_pos_fe57cc4b9f682122_45___format_get,"DateTools","__format_get",0xabb90f8f,"DateTools.__format_get","/home/kaiz0r/haxe/std/DateTools.hx",45,0xa26c38c1)
HX_LOCAL_STACK_FRAME(_hx_pos_fe57cc4b9f682122_110___format,"DateTools","__format",0x77c4edf8,"DateTools.__format","/home/kaiz0r/haxe/std/DateTools.hx",110,0xa26c38c1)
HX_LOCAL_STACK_FRAME(_hx_pos_fe57cc4b9f682122_155_format,"DateTools","format",0x1113a898,"DateTools.format","/home/kaiz0r/haxe/std/DateTools.hx",155,0xa26c38c1)
HX_LOCAL_STACK_FRAME(_hx_pos_fe57cc4b9f682122_166_delta,"DateTools","delta",0x0d31d5b7,"DateTools.delta","/home/kaiz0r/haxe/std/DateTools.hx",166,0xa26c38c1)
HX_LOCAL_STACK_FRAME(_hx_pos_fe57cc4b9f682122_176_getMonthDays,"DateTools","getMonthDays",0x5b0762a2,"DateTools.getMonthDays","/home/kaiz0r/haxe/std/DateTools.hx",176,0xa26c38c1)
HX_LOCAL_STACK_FRAME(_hx_pos_fe57cc4b9f682122_191_seconds,"DateTools","seconds",0x5b7ed1fe,"DateTools.seconds","/home/kaiz0r/haxe/std/DateTools.hx",191,0xa26c38c1)
HX_LOCAL_STACK_FRAME(_hx_pos_fe57cc4b9f682122_198_minutes,"DateTools","minutes",0x54cfb29e,"DateTools.minutes","/home/kaiz0r/haxe/std/DateTools.hx",198,0xa26c38c1)
HX_LOCAL_STACK_FRAME(_hx_pos_fe57cc4b9f682122_205_hours,"DateTools","hours",0x616f1c8e,"DateTools.hours","/home/kaiz0r/haxe/std/DateTools.hx",205,0xa26c38c1)
HX_LOCAL_STACK_FRAME(_hx_pos_fe57cc4b9f682122_212_days,"DateTools","days",0x675da9b8,"DateTools.days","/home/kaiz0r/haxe/std/DateTools.hx",212,0xa26c38c1)
HX_LOCAL_STACK_FRAME(_hx_pos_fe57cc4b9f682122_218_parse,"DateTools","parse",0xf3607df2,"DateTools.parse","/home/kaiz0r/haxe/std/DateTools.hx",218,0xa26c38c1)
HX_LOCAL_STACK_FRAME(_hx_pos_fe57cc4b9f682122_241_make,"DateTools","make",0x6d50890f,"DateTools.make","/home/kaiz0r/haxe/std/DateTools.hx",241,0xa26c38c1)
HX_LOCAL_STACK_FRAME(_hx_pos_fe57cc4b9f682122_254_makeUtc,"DateTools","makeUtc",0x5d162f55,"DateTools.makeUtc","/home/kaiz0r/haxe/std/DateTools.hx",254,0xa26c38c1)
HX_LOCAL_STACK_FRAME(_hx_pos_fe57cc4b9f682122_35_boot,"DateTools","boot",0x6615d353,"DateTools.boot","/home/kaiz0r/haxe/std/DateTools.hx",35,0xa26c38c1)
...
HX_LOCAL_STACK_FRAME(_hx_pos_fe57cc4b9f682122_36_boot,"DateTools","boot",0x6615d353,"DateTools.boot","/home/kaiz0r/haxe/std/DateTools.hx",36,0xa26c38c1)
...
HX_LOCAL_STACK_FRAME(_hx_pos_fe57cc4b9f682122_37_boot,"DateTools","boot",0x6615d353,"DateTools.boot","/home/kaiz0r/haxe/std/DateTools.hx",37,0xa26c38c1)
...
HX_LOCAL_STACK_FRAME(_hx_pos_fe57cc4b9f682122_40_boot,"DateTools","boot",0x6615d353,"DateTools.boot","/home/kaiz0r/haxe/std/DateTools.hx",40,0xa26c38c1)
...
HX_LOCAL_STACK_FRAME(_hx_pos_fe57cc4b9f682122_169_boot,"DateTools","boot",0x6615d353,"DateTools.boot","/home/kaiz0r/haxe/std/DateTools.hx",169,0xa26c38c1)
...
bool DateTools_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x09b9b15d;
}
...
::String DateTools_obj::_hx___format_get( ::Date d,::String e){
            	HX_STACKFRAME(&_hx_pos_fe57cc4b9f682122_45___format_get)
...
HXLINE( 104)			return ::Std_obj::string(d->getFullYear());
...
HXLINE(  67)			::String _hx_tmp3 = ::Std_obj::string(d->getHours());
HXDLIN(  67)			::String _hx_tmp4;
HXDLIN(  67)			if ((e == HX_("H",48,00,00,00))) {
HXLINE(  67)				_hx_tmp4 = HX_("0",30,00,00,00);
            			}
            			else {
HXLINE(  67)				_hx_tmp4 = HX_(" ",20,00,00,00);
            			}
HXDLIN(  67)			return ::StringTools_obj::lpad(_hx_tmp3,_hx_tmp4,2);
...
HXLINE(  93)			int t = d->getDay();
HXLINE(  94)			if ((t == 0)) {
HXLINE(  95)				return HX_("7",37,00,00,00);
            			}
            			else {
HXLINE(  97)				return ::Std_obj::string(t);
            			}
HXLINE(  92)			goto _hx_goto_0;
            		}
            		if (  (_hx_switch_0==HX_("w",77,00,00,00)) ){
HXLINE( 100)			return ::Std_obj::string(d->getDay());
HXDLIN( 100)			goto _hx_goto_0;
            		}
            		if (  (_hx_switch_0==HX_("y",79,00,00,00)) ){
HXLINE( 102)			return ::StringTools_obj::lpad(::Std_obj::string(hx::Mod(d->getFullYear(),100)),HX_("0",30,00,00,00),2);
HXDLIN( 102)			goto _hx_goto_0;
            		}
            		/* default */{
HXLINE( 106)			HX_STACK_DO_THROW(((HX_("Date.format %",1c,c9,ee,03) + e) + HX_("- not implemented yet.",a4,96,be,31)));
            		}
            		_hx_goto_0:;
...
::String DateTools_obj::_hx___format( ::Date d,::String f){
            	HX_GC_STACKFRAME(&_hx_pos_fe57cc4b9f682122_110___format)
HXLINE( 111)		 ::StringBuf r =  ::StringBuf_obj::__alloc( HX_CTX );
HXLINE( 112)		int p = 0;
HXLINE( 113)		while(true){
HXLINE( 114)			int np = f.indexOf(HX_("%",25,00,00,00),p);
HXLINE( 115)			if ((np < 0)) {
HXLINE( 116)				goto _hx_goto_2;
            			}
HXLINE( 118)			{
HXLINE( 118)				 ::Dynamic len = (np - p);
...
HXLINE( 119)			{
HXLINE( 119)				::String x = ::DateTools_obj::_hx___format_get(d,f.substr((np + 1),1));
HXDLIN( 119)				if (hx::IsNotNull( r->charBuf )) {
HXLINE( 119)					r->flush();
            				}
HXDLIN( 119)				if (hx::IsNull( r->b )) {
HXLINE( 119)					r->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x));
            				}
            				else {
HXLINE( 119)					::Array< ::String > r2 = r->b;
HXDLIN( 119)					r2->push(::Std_obj::string(x));
            				}
            			}
HXLINE( 121)			p = (np + 2);
            		}
            		_hx_goto_2:;
HXLINE( 123)		{
HXLINE( 123)			 ::Dynamic len1 = (f.length - p);
HXDLIN( 123)			if (hx::IsNotNull( r->charBuf )) {
HXLINE( 123)				r->flush();
            			}
HXDLIN( 123)			if (hx::IsNull( r->b )) {
HXLINE( 123)				r->b = ::Array_obj< ::String >::__new(1)->init(0,f.substr(p,len1));
            			}
            			else {
HXLINE( 123)				::Array< ::String > r3 = r->b;
HXDLIN( 123)				r3->push(f.substr(p,len1));
            			}
            		}
HXLINE( 124)		return r->toString();
            	}
...
::String DateTools_obj::format( ::Date d,::String f){
            	HX_STACKFRAME(&_hx_pos_fe57cc4b9f682122_155_format)
HXDLIN( 155)		return ::DateTools_obj::_hx___format(d,f);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC2(DateTools_obj,format,return )
 ...
 ::Date DateTools_obj::delta( ::Date d,Float t){
            	HX_STACKFRAME(&_hx_pos_fe57cc4b9f682122_166_delta)
HXDLIN( 166)		return ::Date_obj::fromTime((d->getTime() + t));
            	}
...
int DateTools_obj::getMonthDays( ::Date d){
            	HX_STACKFRAME(&_hx_pos_fe57cc4b9f682122_176_getMonthDays)
HXLINE( 177)		int month = d->getMonth();
HXLINE( 178)		int year = d->getFullYear();
HXLINE( 180)		if ((month != 1)) {
HXLINE( 181)			return ::DateTools_obj::DAYS_OF_MONTH->__get(month);
            		}
HXLINE( 183)		bool isB;
HXDLIN( 183)		bool isB1;
HXDLIN( 183)		if ((hx::Mod(year,4) == 0)) {
HXLINE( 183)			isB1 = (hx::Mod(year,100) != 0);
            		}
            		else {
HXLINE( 183)			isB1 = false;
            		}
HXDLIN( 183)		if (!(isB1)) {
HXLINE( 183)			isB = (hx::Mod(year,400) == 0);
            		}
            		else {
HXLINE( 183)			isB = true;
            		}
HXLINE( 184)		if (isB) {
HXLINE( 184)			return 29;
            		}
            		else {
HXLINE( 184)			return 28;
            		}
HXDLIN( 184)		return 0;
            	}
...
Float DateTools_obj::seconds(Float n){
            	HX_STACKFRAME(&_hx_pos_fe57cc4b9f682122_191_seconds)
HXDLIN( 191)		return (n * ((Float)1000.0));
            	}
...
Float DateTools_obj::minutes(Float n){
            	HX_STACKFRAME(&_hx_pos_fe57cc4b9f682122_198_minutes)
HXDLIN( 198)		return ((n * ((Float)60.0)) * ((Float)1000.0));
            	}
...
Float DateTools_obj::hours(Float n){
            	HX_STACKFRAME(&_hx_pos_fe57cc4b9f682122_205_hours)
HXDLIN( 205)		return (((n * ((Float)60.0)) * ((Float)60.0)) * ((Float)1000.0));
            	}
...
Float DateTools_obj::days(Float n){
            	HX_STACKFRAME(&_hx_pos_fe57cc4b9f682122_212_days)
HXDLIN( 212)		return ((((n * ((Float)24.0)) * ((Float)60.0)) * ((Float)60.0)) * ((Float)1000.0));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(DateTools_obj,days,return )
 ...
 ::Dynamic DateTools_obj::parse(Float t){
            	HX_STACKFRAME(&_hx_pos_fe57cc4b9f682122_218_parse)
HXLINE( 219)		Float s = (t / ( (Float)(1000) ));
HXLINE( 220)		Float m = (s / ( (Float)(60) ));
HXLINE( 221)		Float h = (m / ( (Float)(60) ));
HXLINE( 224)		int _hx_tmp = ::Std_obj::_hx_int(hx::Mod(s,60));
HXLINE( 225)		int _hx_tmp1 = ::Std_obj::_hx_int(hx::Mod(m,60));
HXLINE( 226)		int _hx_tmp2 = ::Std_obj::_hx_int(hx::Mod(h,24));
HXLINE( 222)		return  ::Dynamic(hx::Anon_obj::Create(5)
...
Float DateTools_obj::make( ::Dynamic o){
            	HX_STACKFRAME(&_hx_pos_fe57cc4b9f682122_241_make)
HXDLIN( 241)		return ( (Float)((o->__Field(HX_("ms",66,5f,00,00),hx::paccDynamic) + (((Float)1000.0) * ( (Float)((o->__Field(HX_("seconds",7f,b6,8d,5a),hx::paccDynamic) + (((Float)60.0) * ( (Float)((o->__Field(HX_("minutes",1f,97,de,53),hx::paccDynamic) + (((Float)60.0) * ( (Float)((o->__Field(HX_("hours",cf,2e,64,2b),hx::paccDynamic) + (((Float)24.0) * ( (Float)(o->__Field(HX_("days",97,5a,63,42),hx::paccDynamic)) )))) )))) )))) )))) );
            	}
...
Float DateTools_obj::makeUtc(int year,int month,int day,int hour,int min,int sec){
            	HX_STACKFRAME(&_hx_pos_fe57cc4b9f682122_254_makeUtc)
HXDLIN( 254)		return (( (Float)( ::__hxcpp_utc_date(year,month,day,hour,min,sec)) ) * ((Float)1000.0));
            	}
