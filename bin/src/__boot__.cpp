...
hx::ScriptableRegisterNameSlots(scriptableInterfaceFuncs,5);
...
::sys::db::_Mysql::MysqlConnection_obj::__register();
...
::sys::db::Mysql_obj::__register();
::sys::db::_Mysql::MysqlResultSet_obj::__register();
::sys::db::ResultSet_obj::__register();
::sys::db::_Mysql::D_obj::__register();
...
::haxe::io::BufferInput_obj::__register();
...
::cpp::vm::Unsafe_obj::__register();
::cpp::vm::Profiler_obj::__register();
::cpp::vm::ExecutionTrace_obj::__register();
::cpp::vm::StackFrame_obj::__register();
::cpp::vm::Parameter_obj::__register();
::cpp::cppia::Host_obj::__register();
...
::sys::db::_Mysql::MysqlConnection_obj::__boot();
